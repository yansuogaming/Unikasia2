<?php
/* Smarty version 3.1.38, created on 2024-05-06 10:19:06
...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.38',
  'unifunc' => 'content_66384c2a9a84e8_88803783',
...
function content_66384c2a9a84e8_88803783 (Smarty_Internal_Template $_smarty_tpl) {
...
">
    ...
    <div class="findBox">
        ...
        <ul class="filter tour_types common_wrapper_details checkBlock">
			<?php
$__section_i_6_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['lstCountryTourOutbound']->value) ? count($_loop) : max(0, (int) $_loop));
...
?>
    ...
    <div class="findBoxCity">
        ...
        <?php
$__section_i_7_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['lstRegionTourByCountry']->value) ? count($_loop) : max(0, (int) $_loop));
...
?>
        <div class="findBox"> 
            ...
            <ul class="filter tour_types common_wrapper_details checkBlock">
                <?php
$__section_j_8_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['listCityTourByRegion']->value) ? count($_loop) : max(0, (int) $_loop));
...
?>
    ...
    <div class="findBox"> 
        ...
        <ul class="filter tour_types common_wrapper_details checkBlock">
            <?php
$__section_j_9_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['lstCityTour']->value) ? count($_loop) : max(0, (int) $_loop));
...
?>
    ...
    <div class="findBox border_0">
        ...
        <ul class="filter tour_types common_wrapper_details checkBlock">
            <?php
$__section_i_10_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['lstDeparturePoint']->value) ? count($_loop) : max(0, (int) $_loop));
