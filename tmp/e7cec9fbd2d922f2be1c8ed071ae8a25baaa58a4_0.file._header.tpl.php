...
/* Smarty version 3.1.38, created on 2024-04-08 13:09:38
  from '/home/isocms/domains/isocms.com/private_html/isocms/templates/default/_header.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.38',
  'unifunc' => 'content_66138a22b1b986_49540694',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e7cec9fbd2d922f2be1c8ed071ae8a25baaa58a4' => 
    array (
      0 => '/home/isocms/domains/isocms.com/private_html/isocms/templates/default/_header.tpl',
      1 => 1711692509,
      2 => 'file',
    ),
  ),
...
function content_66138a22b1b986_49540694 (Smarty_Internal_Template $_smarty_tpl) {
			...
			<div class="row header__desktop--right header_top">
				<div class="col-xl-6">
					<div class="header_top_left d-flex align-items-center">
						<?php if ($_smarty_tpl->tpl_vars['mod']->value == 'home' || $_smarty_tpl->tpl_vars['mod']->value == 'homepackage') {?>
                                    ...
                                    <div class="d-flex-menu">
                                        <div class="d-nav-menu">
                                            <ul class="nav nav-tabs nav-pills nav-stacked" role="tablist">
                                                <?php
$__section_i_1_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['lstRegionTour']->value) ? count($_loop) : max(0, (int) $_loop));
                                ...
                                <div class="dropdown-menu mega-menu mg-dropdown mg-s-tours header-mega-menu-new dropdownMenuTravelStyle"
                                    ...
                                    <div class="d-flex-menu">
                                        <div class="d-nav-menu">
                                            <ul class="nav nav-tabs nav-pills nav-stacked" role="tablist">
                                                <?php
$__section_i_5_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['listCountryDestination']->value) ? count($_loop) : max(0, (int) $_loop));
...
?>
                                        ...
                                        <div class="tab-content">
                                            <?php
$__section_i_6_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['listCountryDestination']->value) ? count($_loop) : max(0, (int) $_loop));
...
"><?php echo $_smarty_tpl->tpl_vars['title_country']->value;?>
                                                            ...
                                                            <ul>
                                                                <?php
$__section_j_7_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['lstCountryCat']->value) ? count($_loop) : max(0, (int) $_loop));
...
?>
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['lstCatTour']->value) {?>
                                    <ul class="dropdown-menu dropdown_travelstyle" role="menu">
                                        <?php
$__section_j_8_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['lstCatTour']->value) ? count($_loop) : max(0, (int) $_loop));
                                ...
                                <div class="dropdown-menu mega-menu mg-dropdown mg-s-hotel header-mega-menu-new"
                                    ...
                                    <div class="d-flex-menu">
                                        <div class="d-nav-menu">
                                            <ul class="nav nav-tabs nav-pills nav-stacked" role="tablist">
                                                <?php
$__section_i_9_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['lstCountryHotel']->value) ? count($_loop) : max(0, (int) $_loop));
                                ...
                                <div class="dropdown-menu mega-menu mg-dropdown mg-s-cruise header-mega-menu-new"
                                    ...
                                    <div class="d-flex-menu">
                                        <div class="d-nav-menu">
                                            <ul class="nav nav-tabs nav-pills nav-stacked" role="tablist">
                                                <?php
$__section_i_10_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['lstCruiseCat']->value) ? count($_loop) : max(0, (int) $_loop));
...
" role=link aria-disabled=true><?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Travel Styles');?>
 <i class="fa fa-angle-down" aria-hidden="true"></i></a>
                                <ul class="dropdown-menu dropdown_hotel nav_menu_child" role="menu">
                                    <?php
$__section_i_11_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['lstCatTour']->value) ? count($_loop) : max(0, (int) $_loop));
...
$_smarty_tpl->tpl_vars['__smarty_section_i']->value['first'] = ($__section_i_11_iteration === 1);
?>
