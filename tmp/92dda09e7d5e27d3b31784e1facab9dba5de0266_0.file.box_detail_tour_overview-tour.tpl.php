<?php
/* Smarty version 3.1.38, created on 2024-04-11 08:58:31
  from '/home/isocms/domains/isocms.com/private_html/admin/isocms/templates/default/blocks/box_detail_tour_overview-tour.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.38',
  'unifunc' => 'content_661743c7a19965_46809768',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '92dda09e7d5e27d3b31784e1facab9dba5de0266' => 
    array (
      0 => '/home/isocms/domains/isocms.com/private_html/admin/isocms/templates/default/blocks/box_detail_tour_overview-tour.tpl',
      1 => 1701163735,
      2 => 'file',
    ),
  ),
...
function content_661743c7a19965_46809768 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="box_title_trip_code">
	<div class="row d-flex full-height">
		<div class="col-md-9">
			<div class="fill_data_box">
				<h3 class="title_box mb05"><?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Overview tour');?>

				<?php $_smarty_tpl->_assignInScope('overview_tour', 'overview_tour');?>
				<?php if ($_smarty_tpl->tpl_vars['CHECKHELP']->value == 1) {?>
				<button data-key="<?php echo $_smarty_tpl->tpl_vars['overview_tour']->value;?>
" data-label="<?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Overview tour');?>
" type="button" title="Thêm mô tả" onclick="open_texthelp(this, event)" class="btn btn-xs btn-default"><i class="fa fa-plus-circle"></i></button>
				...
				<p class="intro_box mb40"><?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('introoverviewtour');?>
</p>
...
" data-name="overview" cols="255" rows="2"><?php echo $_smarty_tpl->tpl_vars['oneItem']->value['overview'];?>
</textarea>
						<?php }?>
		...
		<div class="col-md-3">
			<div class="instruction_fill_data_box">
				...
				<div class="content_box">
					<p class="mb0"><?php echo html_entity_decode($_smarty_tpl->tpl_vars['clsConfiguration']->value->getValue($_smarty_tpl->tpl_vars['overview_tour']->value));?>
</p>
				</div>
			</div>
		</div>
