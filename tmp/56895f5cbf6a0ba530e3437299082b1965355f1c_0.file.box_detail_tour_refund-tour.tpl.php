<?php
/* Smarty version 3.1.38, created on 2024-04-12 09:28:07
  from '/home/isocms/domains/isocms.com/private_html/admin/isocms/templates/default/blocks/box_detail_tour_refund-tour.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.38',
  'unifunc' => 'content_66189c37a1c194_32957261',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '56895f5cbf6a0ba530e3437299082b1965355f1c' => 
    array (
      0 => '/home/isocms/domains/isocms.com/private_html/admin/isocms/templates/default/blocks/box_detail_tour_refund-tour.tpl',
      1 => 1701163795,
      2 => 'file',
    ),
  ),
...
function content_66189c37a1c194_32957261 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="box_title_trip_code">
	<div class="row d-flex full-height">
		<div class="col-md-9">
			<div class="fill_data_box">
				<h3 class="title_box mb05"><?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Refund tour');?>

				<?php $_smarty_tpl->_assignInScope('refund_tour', 'refund_tour');?>
				<?php if ($_smarty_tpl->tpl_vars['CHECKHELP']->value == 1) {?>
				<button data-key="<?php echo $_smarty_tpl->tpl_vars['refund_tour']->value;?>
" data-label="<?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Refund tour');?>
" type="button" title="Thêm mô tả" onclick="open_texthelp(this, event)" class="btn btn-xs btn-default"><i class="fa fa-plus-circle"></i></button>
				...
				<p class="intro_box mb40"><?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('introrefundtour');?>
</p>
...
" data-name="refund_policy" cols="255" rows="2"><?php echo $_smarty_tpl->tpl_vars['oneItem']->value['refund_policy'];?>
</textarea>
						<?php }?>
					</div>
				</div>
		...
		<div class="col-md-3">
			<div class="instruction_fill_data_box">
				...
				<div class="content_box">
					<p class="mb0"><?php echo html_entity_decode($_smarty_tpl->tpl_vars['clsConfiguration']->value->getValue($_smarty_tpl->tpl_vars['refund_tour']->value));?>
</p>
				</div>
			</div>
		</div>
