<?php
/* Smarty version 3.1.38, created on 2024-04-08 13:53:54
  from '/home/isocms/domains/isocms.com/private_html/isocms/templates/default/member/signin2.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.38',
  'unifunc' => 'content_66139482328566_05072383',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '4738b24586dcec304be19a2c312f720b4e107571' => 
    array (
      0 => '/home/isocms/domains/isocms.com/private_html/isocms/templates/default/member/signin2.tpl',
      1 => 1666869937,
      2 => 'file',
    ),
  ),
...
function content_66139482328566_05072383 (Smarty_Internal_Template $_smarty_tpl) {
?><main id="signin_main" style="background-image:URL('<?php echo $_smarty_tpl->tpl_vars['clsConfiguration']->value->getValue('site_member_background');?>
')">
	<div class="signin_wrap">
		<div class="signform_box">
			<div class="signformM_wrap">
				<h2><?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Sign in');?>
</h2>
					...
					<form id="signformM_form" method="post" action="" enctype="multipart/form-data" class="AppForm signformM_form">
						<div class="form-group">
							<div class="inner-addon left-addon">
								<input type="text" name="USER" autocomplete="off" class="form-control" id="emaillogin" placeholder="<?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Enter your Email or Username');?>
" required>
							</div>
						...
						<div class="form-group">
							<div class="inner-addon leftaddon">
								<input type="password" name="PASSWORD"  autocomplete="off" class="form-control" id="pwd" placeholder="<?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Enter password');?>
" required>
							</div>
						...
						<div class="remember-forgot">
							<span class="hidden">
								<input name="rememberEmail" type="checkbox"><?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Remember me');?>

							</span>  
							<a id="ForgotPassLink" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#exampleModal" class="fr f_h_main"><?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Forgot password');?>
?</a>
<!--							<a href="<?php echo $_smarty_tpl->tpl_vars['clsProfile']->value->getLink('forgot_pass');?>
" class="fr f_h_main"><?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Forgot password');?>
?</a>-->
						</div>
						<button type="button" class="btn-signIn btn-cmd-submit mb0">
							...
							<span><?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Signin');?>
</span>
						</button>
						<input type="hidden" id="return_url" name="return_url" value="<?php echo $_smarty_tpl->tpl_vars['return_url']->value;?>
"/>
						...
						<div class="modal-content">
						  ...
						  <div class="modal-body">
						  	<div class="body page-bg round-bottom pal">
									<h2 class="mt0 mb20"><?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Password reset');?>
</h2>
									<div class="note size16"><?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('We will send instruction for creating a new password to the email address associated with your account');?>
.</div>
									<form novalidate class="ng-pristine ng-valid">
										<div class="mtm mbm">
											<input type="email" class="isoTxt required txt350" placeholder="<?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Your Email');?>
" name="user_email" value="" />
											<div id="message_box" class="mb10 mt05" style="display:none"></div>
										</div>
										<div class="line mt10">
												<button type="button" id="forgotBtn" class=" submitClick"><?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Reset');?>
 &raquo;</button>
				...
				<section class="signM_social_section"><!---->
					<h3 class="signM_social_head"><span><?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('or sign in with');?>
</span></h3>
			...
			<span><?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('No account yet? Sign up now&#33;');?>
</span><a href="<?php echo $_smarty_tpl->tpl_vars['clsProfile']->value->getLink('signup');?>
...
/member2.css?v=<?php echo $_smarty_tpl->tpl_vars['upd_version']->value;?>
"/>
<?php echo '<script'; ?>
>
...
!";
	var msg_password_required = "<?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Your password should not be empty');?>
!";
	var msg_signin_error = "<?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Account or password was incorrect');?>
!";
	var msg_signin_success = "<?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Signin success');?>
!";
<?php echo '</script'; ?>
>
...
var require_email = "<?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Error &#33; Please enter your email');?>
.";
var require_invalid_email = "<?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Error &#33; Please enter your email valid');?>
.";
var reset_success = "<?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Submit request successful &#33; Please check your email and reset your new password');?>
.";
<?php echo '</script'; ?>
>
