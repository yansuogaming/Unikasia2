<?php
/* Smarty version 3.1.38, created on 2024-04-09 01:13:21
  from '/home/isocms/domains/isocms.com/private_html/isocms/templates/default/member/signup2.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.38',
  'unifunc' => 'content_661433c1b80c72_19325453',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e0a868ab3fa7101cdead2272c0038927faf0dd38' => 
    array (
      0 => '/home/isocms/domains/isocms.com/private_html/isocms/templates/default/member/signup2.tpl',
      1 => 1594375327,
      2 => 'file',
    ),
  ),
...
function content_661433c1b80c72_19325453 (Smarty_Internal_Template $_smarty_tpl) {
	...
	<div class="signin_wrap">
		<div class="signform_box">
			<div class="signformM_wrap">
				<h2><?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Sign up');?>
</h2>
					...
					<form id="frmRegister" method="post" action="" enctype="multipart/form-data" class="AppForm signformM_form">
						<div class="form-group">
							<div class="inner-addon left-addon">
								<input type="text" name="username" autocomplete="off" class="form-control" id="username" placeholder="<?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Enter your Email or Username');?>
" required>
							</div>
						...
						<div class="form-group">
							<div class="inner-addon left-addon">
								<input type="text" name="useremail" autocomplete="off" class="form-control" id="useremail" placeholder="<?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Enter your email');?>
" required>
							</div>
						...
						<div class="form-group">
							<div class="inner-addon leftaddon">
								<input type="password" name="userpass"  autocomplete="off" class="form-control" id="userpass" placeholder="<?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Enter password');?>
" required>
							</div>
						...
						<div class="form-group">
							<div class="inner-addon leftaddon">
								<input type="password" name="confirmpass"  autocomplete="off" class="form-control" id="confirmpass" placeholder="<?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Repeat password');?>
" required>
							</div>
						...
						<div class="form-group">
							<?php if ($_smarty_tpl->tpl_vars['clsISO']->value->getVar('_ISOCMS_CAPTCHA') == 'IMG') {?>
								<label class=" title" for="secure_code">
									<abbr class="required" title="required">*</abbr> <?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('securecode');?>

								</label>
								<div>
									<input autocomplete="off" type="text" class="form-control security_code required" name="secure_code" value="" maxlength="5" />
									<img src="<?php echo $_smarty_tpl->tpl_vars['PCMS_URL']->value;?>
/captcha.php?sid=<?php echo $_smarty_tpl->tpl_vars['sid']->value;?>
" width="80" height="36" alt="Secure" />
								</div>
							<?php } else { ?>
								<div class="g-recaptcha" data-sitekey="<?php echo $_smarty_tpl->tpl_vars['clsISO']->value->getVar('reCAPTCHA_KEY');?>
"></div>
								<?php if ($_smarty_tpl->tpl_vars['msgSubmitForm']->value != '') {?>
								<div class="error text_left"><?php echo $_smarty_tpl->tpl_vars['msgSubmitForm']->value;?>
</div>
								<?php }?>
							<?php }?>
						</div> 
						<button type="button" class="btn-signIn btn-cmd-submit mb0">
							...
							<span><?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Signup');?>
</span>
						</button>
			...
			<span><?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Already have a account');?>
?</span><a href="<?php echo $_smarty_tpl->tpl_vars['clsProfile']->value->getLink('signin');?>
" title="<?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Sign in');?>
...
<?php echo '<script'; ?>
>
	var msg_username_required = "<?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Your username should not be empty');?>
!";
...
!";
	var msg_email_exits = "<?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Email Exits');?>
!";
	var msg_password_required = "<?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Your password should not be empty');?>
!";
	var msg_re_password_required = "<?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Your comfirm password should not be empty');?>
!";
	var msg_match_password_required = "<?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Confirm password do not match');?>
!";
	var msg_signup_error = "<?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Account or password was incorrect');?>
!";
	var msg_signup_success = "<?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Signup success');?>
!";
