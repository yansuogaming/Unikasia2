<?php
/* Smarty version 3.1.38, created on 2024-04-12 09:27:08
  from '/home/isocms/domains/isocms.com/private_html/admin/isocms/templates/default/blocks/box_detail_tour_whatcarry-tour.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.38',
  'unifunc' => 'content_66189bfc20a381_08812906',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'fc561f0be7f31e495a57d2568c6139fe9c4c9dcd' => 
    array (
      0 => '/home/isocms/domains/isocms.com/private_html/admin/isocms/templates/default/blocks/box_detail_tour_whatcarry-tour.tpl',
      1 => 1701163920,
      2 => 'file',
    ),
  ),
...
function content_66189bfc20a381_08812906 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="box_title_trip_code">
	<div class="row d-flex full-height">
		<div class="col-md-9">
			<div class="fill_data_box">
				<h3 class="title_box mb05"><?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('What carry tour');?>

				<?php $_smarty_tpl->_assignInScope('carry_tour', 'carry_tour');?>
				<?php if ($_smarty_tpl->tpl_vars['CHECKHELP']->value == 1) {?>
				<button data-key="<?php echo $_smarty_tpl->tpl_vars['carry_tour']->value;?>
" data-label="<?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('What carry tour');?>
" type="button" title="Thêm mô tả" onclick="open_texthelp(this, event)" class="btn btn-xs btn-default"><i class="fa fa-plus-circle"></i></button>
				...
				<p class="intro_box mb40"><?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('introwhatcarrytour');?>
</p>
				<div class="form_option_tour">
					<div class="inpt_tour">
												<p class="not_text_tour"><?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('fill What carry');?>
</p>
...
" data-name="thing_to_carry" cols="255" rows="3"><?php echo $_smarty_tpl->tpl_vars['oneItem']->value['thing_to_carry'];?>
</textarea>
						<?php }?>
					</div>
				</div>
		...
		<div class="col-md-3">
			<div class="instruction_fill_data_box">
				...
				<div class="content_box">
					<p class="mb0"><?php echo html_entity_decode($_smarty_tpl->tpl_vars['clsConfiguration']->value->getValue($_smarty_tpl->tpl_vars['carry_tour']->value));?>
</p>
				</div>
			</div>
		</div>
