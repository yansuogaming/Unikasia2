...
/* Smarty version 3.1.38, created on 2024-04-08 13:11:54
  from '/home/isocms/domains/isocms.com/private_html/isocms/templates/default/blocks/filter_left_trip.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.38',
  'unifunc' => 'content_66138aaa8ae064_78026029',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '365c9d0207806f8146dcee9828d95812d6fba86e' => 
    array (
      0 => '/home/isocms/domains/isocms.com/private_html/isocms/templates/default/blocks/filter_left_trip.tpl',
      1 => 1706059676,
      2 => 'file',
    ),
  ),
...
function content_66138aaa8ae064_78026029 (Smarty_Internal_Template $_smarty_tpl) {
...
">
    ...
    <div class="findBox">
        ...
        <ul class="filter tour_types common_wrapper_details checkBlock">
			<?php
$__section_i_1_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['lstCountryTourOutbound']->value) ? count($_loop) : max(0, (int) $_loop));
...
?>
    ...
    <div class="findBoxCity">
        ...
        <?php
$__section_i_2_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['lstRegionTourByCountry']->value) ? count($_loop) : max(0, (int) $_loop));
...
?>
    ...
    <div class="findBox"> 
        ...
        <ul class="filter tour_types common_wrapper_details checkBlock">
            <?php
$__section_j_4_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['lstCityTour']->value) ? count($_loop) : max(0, (int) $_loop));
...
?>
    ...
    <div class="findBox border_0">
        ...
        <ul class="filter tour_types common_wrapper_details checkBlock">
            <?php
$__section_i_5_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['lstDeparturePoint']->value) ? count($_loop) : max(0, (int) $_loop));
...
?>
    ...
    <div class="findBox border_0">
        ...
        <ul class="filter tour_types common_wrapper_details checkBlock">
            <?php
$__section_i_6_loop = (is_array(@$_loop=$_smarty_tpl->tpl_vars['lstCatTour']->value) ? count($_loop) : max(0, (int) $_loop));
