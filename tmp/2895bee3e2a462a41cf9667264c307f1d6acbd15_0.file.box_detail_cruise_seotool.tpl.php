<?php
/* Smarty version 3.1.38, created on 2024-04-09 10:01:19
  from '/home/isocms/domains/isocms.com/private_html/admin/isocms/templates/default/blocks/box_detail_cruise_seotool.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.38',
  'unifunc' => 'content_6614af7f9913d6_46319997',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2895bee3e2a462a41cf9667264c307f1d6acbd15' => 
    array (
      0 => '/home/isocms/domains/isocms.com/private_html/admin/isocms/templates/default/blocks/box_detail_cruise_seotool.tpl',
      1 => 1697513710,
      2 => 'file',
    ),
  ),
...
function content_6614af7f9913d6_46319997 (Smarty_Internal_Template $_smarty_tpl) {
...
">
 ...
 <span class="required_red">*</span>						
                <?php $_smarty_tpl->_assignInScope('meta_title_cruise', 'meta_title_cruise');?>
                <?php $_smarty_tpl->_assignInScope('help_first', $_smarty_tpl->tpl_vars['meta_title_cruise']->value);?>
                <?php if ($_smarty_tpl->tpl_vars['CHECKHELP']->value == 1) {?>
                <button data-key="<?php echo $_smarty_tpl->tpl_vars['meta_title_cruise']->value;?>
...
.</span>
                <div class="text_help" hidden=""><?php echo html_entity_decode($_smarty_tpl->tpl_vars['clsConfiguration']->value->getValue($_smarty_tpl->tpl_vars['meta_title_cruise']->value));?>
</div>
            </div>
            <div class="form-group">
                <label class="col-form-label" for="config_value_intro"><?php echo $_smarty_tpl->tpl_vars['core']->value->get_Lang('Meta Description');?>
 <span class="required_red">*</span>
                <?php $_smarty_tpl->_assignInScope('meta_description_cruise', 'meta_description_cruise');?>
                <?php if ($_smarty_tpl->tpl_vars['CHECKHELP']->value == 1) {?>
                <button data-key="<?php echo $_smarty_tpl->tpl_vars['meta_description_cruise']->value;?>
...
.</span>
                <div class="text_help" hidden=""><?php echo html_entity_decode($_smarty_tpl->tpl_vars['clsConfiguration']->value->getValue($_smarty_tpl->tpl_vars['meta_description_cruise']->value));?>
</div>
            </div>
 ...
 <span class="required_red">*</span>
                <?php $_smarty_tpl->_assignInScope('image_share_social_cruise', 'image_share_social_cruise');?>
                <?php if ($_smarty_tpl->tpl_vars['CHECKHELP']->value == 1) {?>
                <button data-key="<?php echo $_smarty_tpl->tpl_vars['image_share_social_cruise']->value;?>
...
","toField":"image","toId":"isoman_show_image_seo","hiddenId":"isoman_hidden_image_seo"})' class="btn btn-upload-choice ajOpenDialog" isoman_for_id="image_seo" isoman_name="image"><?php echo $_smarty_tpl->tpl_vars['clsISO']->value->makeIcon('folder-o',$_smarty_tpl->tpl_vars['core']->value->get_Lang('From library'));?>
                            ...
                            <div class="text_help" hidden=""><?php echo html_entity_decode($_smarty_tpl->tpl_vars['clsConfiguration']->value->getValue($_smarty_tpl->tpl_vars['image_share_social_cruise']->value));?>
</div>
                        </div>
                    </div>
