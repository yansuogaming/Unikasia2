...
function default_editcat()
{
    ...
    $clsCountry = new Country();
    $assign_list["clsCountry"] = $clsCountry;
    $lstCountry = $clsCountry->getAll("is_trash=0 and is_online=1");
    $assign_list["lstCountry"] = $lstCountry;
    $countCountry = !empty($lstCountry) ? count($lstCountry) : 0;
    $assign_list["countCountry"] = $countCountry;
    #
    $classTable = "GuideCat";
    $clsClassTable = new $classTable;
    $tableName = $clsClassTable->tbl;
...
require_once(DIR_MODULES . '/guide/mod_default.php');
