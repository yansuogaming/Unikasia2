...
function default_insert()
{
    ...
    global $assign_list, $_CONFIG, $_SITE_ROOT, $mod, $_LANG_ID, $act, $menu_current, $current_page, $oneSetting, $core, $pvalTable, $clsModule, $clsButtonNav, $dbconn, $clsISO, $clsConfiguration, $adult_type_id, $child_type_id, $infant_type_id, $show, $nextstep;
    #
    $clsCountry    =    new Country();
    $assign_list["clsCountry"]     =     $clsCountry;
    // $clsISO->dd($clsCountry->makeSelectboxOption());
    #
...
function default_ajActionNewFaq()
{
    ...
    if ($tp = 'S') {
        ...
        $results = array('result' => 'success', 'link' => 'faqs/insert/' . $faq_id . '/overview');
    }
    // Return
