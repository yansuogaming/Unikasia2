<?php
	...
	if(isset($_POST['submit']) && $_POST['submit'] == 'UpdateMeta'){
		if($_POST['config_value_title']!='' && $_POST['config_value_intro']!=''){
			...
			$clsMeta->updateOne($meta_id,"config_value_title='".addslashes($_POST['config_value_title'])."',config_value_intro='".addslashes($_POST['config_value_intro'])."',config_value_keyword='".addslashes($_POST['config_value_keyword'])."',image='".addslashes($_POST['isoman_url_image_seo'])."',reg_date='".time()."',upd_date='".time()."',meta_index='".$_POST['meta_index']."',meta_follow='".$_POST['meta_follow']."'");
		}
