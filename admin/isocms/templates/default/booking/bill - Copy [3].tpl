							...
							<table class="table_booking_child">
								...
								<tbody>
									...
									<tr>
										...
										<td style="text-align: right;width:20%">{$item.price_adults_z|number_format:0:".":" "} {$clsISO->getShortRate()}</td>
										<td style="text-align: right;width:20%">{$item.total_price_adults|number_format:0:".":" "} {$clsISO->getShortRate()}</td>
									</tr>
									{/if}
									...
									<tr>
										...
										<td style="text-align: right;width:20%">{$item.price_child_z|number_format:0:".":" "} {$clsISO->getShortRate()}</td>
										<td style="text-align: right;width:20%">{$item.total_price_child|number_format:0:".":" "} {$clsISO->getShortRate()}</td>
									</tr>
									{/if}
									...
									<tr>
										...
										<td style="text-align: right;width:20%">{$item.price_infants_z|number_format:0:".":" "} {$clsISO->getShortRate()}</td>
										<td style="text-align: right;width:20%">{$item.total_price_infants|number_format:0:".":" "} {$clsISO->getShortRate()}</td>
									</tr>
									{/if}
									...
									<tr class="tr_promotion">
										...
										<td style="text-align: right;width:20%">-{$item.promotion_z}%</td>
										<td style="text-align: right;width:20%">{$item.price_promotion|number_format:0:".":" "} {$clsISO->getShortRate()}</td>
									</tr>
									{/if}
								</tbody>
							</table>
								...
								<table class="table_booking_child">
									...
									<tbody>
										...
										<tr>
											...
											<td style="text-align: right;width:20%">{$item_room.totalprice|number_format:0:".":" "} {$clsISO->getShortRate()}</td>
											<td style="text-align: right;width:20%">{$price|number_format:0:".":" "} {$clsISO->getShortRate()}</td>
										</tr>
										{/foreach}
										...
										<tr class="tr_promotion" style="background: #CFF4E0">
											...
											<td style="text-align: right;width:20%">-{$discount.discount_value}%</td>
											<td style="text-align: right;width:20%">{$item.totalPricePromotionHotel|number_format:0:".":" "} {$clsISO->getShortRate()}</td>
										</tr>
										{/if}
									</tbody>
								</table>
								...
								<table class="table_booking_child">
									...
									<tbody>
										...
										<tr>
											...
											<td style="text-align: right;width:20%">{$item_cabin.totalprice|number_format:0:".":" "} {$clsISO->getShortRate()}</td>
											<td style="text-align: right;width:20%">{$item_cabin.totalprice|number_format:0:".":" "} {$clsISO->getShortRate()}</td>
										</tr>
										{/foreach}
										...
										<tr class="tr_promotion">
											...
											<td style="text-align: right;width:20%">-{$discount.discount_value}%</td>
											<td style="text-align: right;width:20%">{$item.totalPricePromotionCruise|number_format:0:".":" "} {$clsISO->getShortRate()}</td>
										</tr>
										{/if}
									</tbody>
								</table>
								...
								<table class="table_booking_child">
									...
									<tbody>
										<tr>
											...
											<td style="text-align: right;width:20%">{$price|number_format:0:".":" "} {$clsISO->getShortRate()}</td>
											<td style="text-align: right;width:20%">{$price_total|number_format:0:".":" "} {$clsISO->getShortRate()}</td>
										</tr>
										{if $price_promotion}
										...
										<tr class="tr_promotion">
											...
											<td style="text-align: right;width:20%">-{$discount.discount_value}%</td>
											<td style="text-align: right;width:20%">{$price_promotion|number_format:0:".":" "} {$clsISO->getShortRate()}</td>
										</tr>
										{/if}
									</tbody>
								</table>
