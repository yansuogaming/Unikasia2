$().ready(function(){
	...
	if(mod == 'cruise' && act== 'property') {
		...
		$(document).on('click', '.clickSubmitProperty', function(ev){
			...
			if($type!="GroupSize" && $type!="Conditions" && $type!="GroupCabinFacilities" && $type!="GroupCruiseFacilities" && $type!="CabinFacilities"  && $type!="CruiseFacilities" && $type!="ThingLove" && $type!="GroupNearestEssentials" && $type!="NearestEssentials" && $type!="GroupUsefulInformation" && $type!="UsefulInformation" && $type!="GroupBenefits"){
