	...
	<div class="container-fluid container-fluid-2 d-flex">
		...
		<div class="content_setting_box">
			<div class="page-title d-flex">
				<div class="title">
					<h2>{$core->get_Lang($type)} <div class="info_module" data-toggle="tooltip" data-placement="right" title="Chức năng quản lý danh sách các {$core->get_Lang($type)} trong hệ thống isoCMS">i</div>
					</h2>
