<div class="page_container">
	<div class="page-title d-flex">
		...
		<div class="button_right">
			<a href="{$PCMS_URL}/?mod={$mod}&act=edit" class="btn btn-main btn-addnew" title="{$core->get_Lang('Add country')}">{$core->get_Lang('Add country')}</a>
		</div>
    </div>
								...
								<td data-title="{$core->get_Lang('func')}" class="block_responsive text-center" style="vertical-align: middle; width: 10px; text-align:left; white-space: nowrap;">
									<div class="btn-group">
										...
										<ul class="dropdown-menu" style="right:0px !important">
											...
											<li><a title="{$core->get_Lang('edit')}" href="{$PCMS_URL}/?mod={$mod}&act=edit&country_id={$core->encryptID($country_id)}{$pUrl}"><i class="icon-edit"></i> {$core->get_Lang('edit')}</a></li>
