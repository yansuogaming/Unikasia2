								...
								{if $totalBooking gt '0'}
									...
									{if $lstBookingTour}
										...
										{section name=i loop=$lstBookingTour}
											{assign var=tour_id value=$clsBooking->getServiceID($lstBookingTour[i].booking_id,'tour')}
											<div class="bookingItem">
												<div class="bookingTop">
													<div class="row">
														<div class="col-sm-3">
														...
														<div class="col-sm-9">
															<div class="detail_hotel_booking">
																...
																{if $clsTour->getCityAround($tour_id) ne ''}
																	<p class="address"><i class="fa fa-map-marker"></i> {$clsTour->getCityAround($tour_id)}</p>
																{/if}
																<div class="clear">&nbsp;</div>
															</div>
														</div>
