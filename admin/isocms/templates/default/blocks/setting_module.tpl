    ...
    <div class="page-title">
		...
		<div id="clienttabs">
			<ul>
				...
				{if $clsISO->checkInArray('page',$mod)}
				{else}
		...
		<div id="tab_content">
			<div class="tabbox">
				...
				<table class="form" cellpadding="3" cellspacing="3">
					...
					{if $clsISO->checkInArray('cruise,blog',$mod)}
					{else}
					<tr class="row-span">
					...
					{/if}
					{if $clsISO->checkInArray('cruise,download,faqs,feedback,guide,news,recruit,service,testimonial',$mod)}
					{else}
                    <tr class="row-span">
