		...
		<div class="fr col_Right">
			<div class="row-field">
				...
				<div class="coltrols {$meta_id}">
					...
					<input class="text full" name="config_value_title"  onkeyup="countCharTitle(this)" value="{$clsMeta->getMetaTitle($meta_id)}" maxlength="255" type="text">
			...
			<div class="row-field">
				...
				<div class="coltrols">
					...
					<textarea name="config_value_intro" class="text full"  onkeyup="countCharDes(this)" style="height:60px">{$clsMeta->getMetaDescription($meta_id)}</textarea>
				</div>
			</div>
