			...
			<div class="col-xs-12 filter_box">
				<form id="forums" method="post" class="filterForm" action="">
					...
					<div class="form-group form-country">
						<select name="country_id" onchange="document.getElementById('forums').submit();" class="form-control select" style="width:240px !important;font-size:14px;">{$clsCountry->makeSelectboxOption($country_id)}</select>
					</div>
