						...
						<tbody id="SortAble">
							...
							<tr style="cursor:move" id="order_{$region_id}" class="{cycle values="row1,row2"}" >
								...
								<td class="text-left name_service">
									<a style="display:inline-block" class="sumary" href="{$PCMS_URL}/?mod={$mod}&act=edit&region_id={$core->encryptID($region_id)}{$pUrl}"><span style="font-size:16px;">{$clsClassTable->getTitle($region_id)}</span></a>
								...
								<td data-title="{$core->get_Lang('func')}" class="block_responsive" style="vertical-align: middle; width: 10px; text-align:left; white-space: nowrap;">
									<div class="btn-group">
										...
										<ul class="dropdown-menu" style="right:0px !important">
											...
											{/if}
											<li><a title="{$core->get_Lang('edit')}" href="{$PCMS_URL}/?mod={$mod}&act=edit&region_id={$core->encryptID($region_id)}{$pUrl}"><i class="icon-edit"></i> {$core->get_Lang('edit')}</a></li>
