            ...
            <table class="form" width="100%" border="0" cellspacing="2" cellpadding="3">
            	 <tr>
                    ...
                    <td class="fieldarea  block767 full_width_767">
                        <input class="text full required" name="iso-title" style="padding:5px" value="{$clsClassTable->getTitle($pvalTable,2)}" maxlength="255" type="text">
                    </td>
                </tr>
            	<tr>
                    <td class="fieldlabel span20  block767 full_width_767 text_left_767">{$core->get_Lang('From')} <font color="red">*</font></td>
                    <td class="fieldarea  block767 full_width_767">
                        <input type="text" class="text full" name="iso-fromname" size="25" value="{$clsClassTable->getFromName($pvalTable,2)}" placeholder="Join Carter,..." data-enter-submit="true" style="width:40%" />
                        <input type="text" class="text full" name="iso-fromemail" size="40" value="{$clsClassTable->getFromEmail($pvalTable,2)}" data-enter-submit="true" placeholder="example@email.com" style="width:40%"> 
                    </td>
                </tr>
                <tr>
                    <td class="fieldlabel span20  block767 full_width_767 text_left_767"> {$core->get_Lang('Copy To')} </td>
                    <td class="fieldarea  block767 full_width_767">
                        <input type="text" name="iso-copyto" size="50" style="padding:5px" value="{$clsClassTable->getCopyTo($pvalTable,2)}" data-enter-submit="true" placeholder="example@email.com,..." />
                ...
                <tr>
                    ...
                    <td class="fieldarea  block767 full_width_767">
                        <input class="text full required" name="iso-subject" style="padding:5px" value="{$clsClassTable->getSubject($pvalTable,2)}" maxlength="255" type="text"  placeholder="Subject E-Mail" />
                    </td>
                </tr>
                <tr>
                    <td class="fieldlabel span20  block767 full_width_767 text_left_767">{$core->get_Lang('content')} <font color="red">*</font></td>
                    <td class="fieldarea  block767 full_width_767">
                        {$clsForm->showInput('content')}
                        <div class="clearfix mt10"></div>
                        <a href="javascript:void(0);" title="{$core->get_Lang('toggleedior')}" class="iso-button-primary toggle">
                            <i class="fa fa-toggle-on"></i> <span>{$core->get_Lang('toggleedior')}</span>
                        </a>
                        {literal}
