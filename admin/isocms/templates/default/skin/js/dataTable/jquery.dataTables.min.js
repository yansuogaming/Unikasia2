...
d[c]=f,"o"===b[1]&&G(a[f]))});a._hungarianMap=d}function O(a,b,c){a._hungarianMap||G(a);var d;k.each(b,function(f,e){d=a._hungarianMap[f];d===q||!c&&b[d]!==q||("o"===d.charAt(0)?(b[d]||(b[d]={}),k.extend(!0,b[d],b[f]),O(a[d],b[d],c)):b[d]=b[f])})}function ma(a){var b=u.defaults.oLanguage,c=b.sDecimal;c&&Va(c);if(a){var d=a.sZeroRecords;!a.sEmptyTable&&d&&No_data_available_in_table===b.sEmptyTable&&V(a,a,"sZeroRecords","sEmptyTable");!a.sLoadingRecords&&d&&"Loading..."===b.sLoadingRecords&&V(a,a,
...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:20,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": "+activate_to_sort_column_ascending,sSortDescending:": "+activate_to_sort_column_descending},oPaginate:{sFirst:First,sLast:Last,sNext:Next,sPrevious:Previous},sEmptyTable:No_data_available_in_table,sInfo:Showing+" _START_ " +to+ " _END_ " +of+ " _TOTAL_ "+entries,sInfoEmpty:Showing+" 0 " + to + " 0 " + of + " 0 " +entries,sInfoFiltered:"("+filtered+" "+from+" _MAX_ "+total+" "+entries+")",
