...
$.extend($.validator, {
	...
	messages: {
		...
		url: "Bạn vui lòng gõ đúng url. Ví dụ: <strong>http://domain.com</strong>.",
	...
	$.fn.priceFormat = function(options)
	{
		...
		return this.each(function()
		{
			...
			function key_check (e)
			{
				...
				if (ctrlDown && code==67) functional = true;
   				if (ctrlDown && code==86) functional = true;
				if (!functional)
				{
					e.preventDefault();
					e.stopPropagation();
