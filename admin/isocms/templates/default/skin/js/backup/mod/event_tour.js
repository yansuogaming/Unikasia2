$().ready(function(){
	...
	$('.clickChooiseTour').live('click',function(){
		...
		$.ajax({
			type:'POST',	
			url:path_ajax_script+'/index.php?mod=event_tour&act=ajAddTourExtension',	
			data: adata,	
			dataType:'html',	
	...
	$('.moveTourExtension').live('click',function(){
		...
		$.ajax({
			type:'POST',	
			url:path_ajax_script+'/index.php?mod=event_tour&act=ajMoveTourExtension',	
			data: adata,	
			dataType:'html',	
			success:function(html){
				loadTourExtension(tour_id);
	...
	$('.clickDeleteTourExtension').live('click',function(){
		...
		if(confirm(confirm_delete)){
			...
			$.ajax({
				type:'POST',	
				url:path_ajax_script+'/index.php?mod=event_tour&act=ajDeleteTourExtension',	
				data: adata,	
				dataType:'html',	
				success:function(html){
					loadTourExtension(tour_id);
	...
	$('.moveDestination').live('click',function(){
		...
		$.ajax({
			type:'POST',	
			url:path_ajax_script+'/index.php?mod=event_tour&act=ajMoveDestination',	
			data: adata,	
			dataType:'html',	
			success:function(html){
				loadDestination(tour_id);
	...
	$('.clickDeleteDestination').live('click',function(){
		...
		if(confirm(confirm_delete)){
			...
			$.ajax({
				type:'POST',	
				url:path_ajax_script+'/index.php?mod=event_tour&act=ajDeleteSelectedCity',	
				data: adata,	
				dataType:'html',	
				success:function(html){
					loadDestination(tour_id);
	...
	$('#clickToAddItinerary').live('click',function(){
		...
		$.ajax({
			type: "POST",
			url:path_ajax_script+'/index.php?mod=event_tour&act=ajLoadFormAddItinerary',
			data: adata,
			dataType: "html",
			success: function(html){
	...
	$('.moveItinerary').live('click',function(){
		...
		$.ajax({
			type:'POST',	
			url:path_ajax_script+'/index.php?mod=event_tour&act=ajMoveItinerary',	
			data: adata,	
			dataType:'html',	
			success:function(html){
				loadItinerary(tour_id);
	...
	$('.clickDeleteItinerary').live('click',function(){
		...
		if(confirm(confirm_delete)){
			...
			$.ajax({
				type:'POST',	
				url:path_ajax_script+'/index.php?mod=event_tour&act=ajDeleteItinerary',	
				data: adata,	
				dataType:'html',	
				success:function(html){
					loadItinerary(tour_id);
	...
	$('.clickEditItinerary').live('click',function(){
		...
		$.ajax({
			type: "POST",
			url:path_ajax_script+'/index.php?mod=event_tour&act=ajLoadFormEditItinerary',
			data: adata,
			dataType: "html",
			success: function(html){
	...
	$('.submitItineration').live('click',function(){
		...
		$('#frmItinerary').ajaxSubmit({
			type: "POST",
			url:path_ajax_script+'/index.php?mod=event_tour&act=ajSubmitItinerary',
			data: {
				'tour_id' 		: 	tour_id,
	...
	$('#clickToManagerDestination').click(function(){
		$.ajax({
			type: "POST",
			url: path_ajax_script+"/index.php?mod=event_tour&act=ajLoadFormManagerDestination",
			data: {
				'tour_id'	: tour_id	
			},
			dataType: "html",
	...
	$('input[class=chkid_city]').live('change',function(){
		...
		$.ajax({
			type: "POST",
			url: path_ajax_script+"/index.php?mod=event_tour&act=ajSaveDestionation",
			data: adata,
			dataType: "html",
			success: function(html){
	...
	$('#addTourPriceRow').live('click',function(){
		...
		$.ajax({
			type: 'POST',
			url:path_ajax_script+'/index.php?mod=event_tour&act=ajLoadNewTourPriceRow',	 
			dataType:'html', 
			data: {
				'tour_id':tour_id
			},
	...
	$('#addTourPriceCol').live('click',function(){
		...
		$.ajax({
			type: 'POST',
			url:path_ajax_script+'/index.php?mod=event_tour&act=ajLoadNewTourPriceCol', 
			dataType:'html', 
			data: {
				'tour_id':tour_id
			},
	...
	$('#clickToAddTourPriceCol').live('click',function(){
		...
		$.ajax({
			type: 'POST',
			url:path_ajax_script+'/index.php?mod=event_tour&act=ajAddTourPriceCol',  
			data: adata,
			dataType:'html',
			success: function(html){
				$('#ajax-indicator').hide();
	...
	$('.clickToAddTourPriceRow').live('click',function(){
		...
		$.ajax({
			type: 'POST',
			url:path_ajax_script+'/index.php?mod=event_tour&act=ajAddTourPriceRow',   
			data: adata,
			dataType:'html',
			success: function(html){
				$('#ajax-indicator').hide();
	...
	$('.editTourPriceCol').live('click',function(){
		...
		$.ajax({
			type: 'POST',
			url: path_ajax_script+'/index.php?mod=event_tour&act=ajCheckTourPriceCol', 
			data: adata,
			dataType:'html',
			success: function(html){
				if(html==0){
					...
					$.ajax({
						type: 'POST',
						url:path_ajax_script+'/index.php?mod=event_tour&act=ajLoadEditTourPriceCol',
						dataType:'html', 
						data: {
							'id':_this.attr('data')
						},
	...
	$('.editTourPriceRow').live('click',function(){
		...
		$.ajax({
			type: 'POST',
			url:path_ajax_script+'/index.php?mod=event_tour&act=ajLoadEditTourPriceRow', 
			dataType:'html', 
			data: {
				'id':_this.attr('data')
			},
	...
	$('#clickToEditTourPriceRow').live('click',function(){
		...
		$.ajax({
			type: 'POST',
			url:path_ajax_script+'/index.php?mod=event_tour&act=ajUpdateTourPriceRow', 
			data: adata,
			dataType:'html',
			success: function(html){
				$('#ajax-indicator').hide();
	...
	$('#clickToEditTourPriceCol').live('click',function(){
		...
		$.ajax({
			type: 'POST',
			url:path_ajax_script+'/index.php?mod=event_tour&act=ajUpdateTourPriceCol', 
			data: adata,
			dataType:'html',
			success: function(html){
				$('#ajax-indicator').hide();
	...
	$('.deleteTourPriceRow').live('click',function(){
		if(confirm('Bạn có chắc chắn muốn xóa dòng này ?')){
			...
			$.ajax({
				type: 'POST',
				url:path_ajax_script+'/index.php?mod=event_tour&act=ajDeleteTourPriceRow', 
				data: adata,
				dataType:'html',
				success: function(html){
					$('#ajax-indicator').hide();
	...
	$('.deleteTourPriceCol').live('click',function(){
		if(confirm('Bạn có chắc chắn muốn xóa cột này ?')){
			...
			$.ajax({
				type: 'POST',
				url:path_ajax_script+'/index.php?mod=event_tour&act=ajDeleteTourPriceCol',  
				data: adata,
				dataType:'html',
				success: function(html){
					$('#ajax-indicator').hide();
		...
		$.ajax({
			...
			success: function(html){
				if(html==0){
					...
					$.ajax({
						type: 'POST',
						url:path_ajax_script+'/index.php?mod=event_tour&act=ajLoadEditTourPriceVal',  
						dataType:'html', 
						data: {
	...
	$('#clickToEditTourPriceVal').live('click',function(){
		...
		$.ajax({
			type: 'POST',
			url:path_ajax_script+'/index.php?mod=event_tour&act=ajUpdateTourPriceVal',   
			data: adata,
			dataType:'html',
			success: function(html){
				$('#ajax-indicator').hide();
	...
	$('.moveTourPriceRow').live('click',function(){
		...
		$.ajax({
			type: 'POST',
			url: path_ajax_script+'/index.php?mod=event_tour&act=ajMoveTourPriceRow', 
			data: adata,
			dataType:'html',
			success: function(html){
				$('#ajax-indicator').hide();
	...
	$('.moveTourPriceCol').live('click',function(){
		...
		$.ajax({
			type: 'POST',
			url: path_ajax_script+'/index.php?mod=event_tour&act=ajMoveTourPriceCol', 
			data: adata,
			dataType:'html',
			success: function(html){
				$('#ajax-indicator').hide();
	...
	$('#resetTourPriceDefault').live('click',function(){
		if(confirm("Bạn có chắc muốn xóa bỏ bảng giá này")){
			...
			$.ajax({
				type: 'POST',
				url: path_ajax_script+'/index.php?mod=event_tour&act=ajResetTourPriceDefault', 
				data: adata,
				dataType:'html',
				success: function(html){
	...
	$('#clickToAddMoreInformation').live('click',function(){
			...
			if(_this.attr('action')=='_ADD'){
				...
				$.ajax({
					type: "POST",
					url: path_ajax_script+"/index.php?mod=event_tour&act=ajLoadFieldAddInformation",
					data: adata,
					dataType: "html",
					success: function(html){
						loadListCustomField();
				...
				if(_type=='_CUSTOM'){
					...
					$.ajax({
						type: "POST",
						url: path_ajax_script+"/index.php?mod=event_tour&act=ajGetFormAddTourCustomField",
						data: adata,
						dataType: "html",
						success: function(html){
		...
		$('#clickAddCustomField').live('click',function(){
			...
			$.ajax({
				type: "POST",
				url: path_ajax_script+"/index.php?mod=event_tour&act=ajSubmitAddCustomField",
				data: adata,
				dataType: "html",
				success: function(html){
					loadListCustomField();
		...
		$('.clickEditCustomField').live('click',function(){
			...
			$.ajax({
				type: "POST",
				url: path_ajax_script+"/index.php?mod=event_tour&act=ajLoadFormEditCustomField",
				data: adata,
				dataType: "html",
				success: function(html){
		...
		$('.clickMoveCustomField').live('click',function(){
			...
			$.ajax({
				type: "POST",
				url: path_ajax_script+"/index.php?mod=event_tour&act=ajMoveTourCustomField",
				data: adata,
				dataType: "html",
				success: function(html){
					loadListCustomField();
		...
		$('.clickDeleteCustomField').live('click',function(){
			if(confirm(confirm_delete)){
				...
				$.ajax({
					type: "POST",
					url: path_ajax_script+"/index.php?mod=event_tour&act=ajDeleteTourCustomField",
					data: adata,
					dataType: "html",
					success: function(html){
						loadListCustomField();
		...
		$('#deleteFile').live('click',function(){
			...
			$.ajax({
				type: "POST",
				url: path_ajax_script+"/index.php?mod=event_tour&act=ajRemoveImageItinerary",
				data: adata,
				dataType: "html",
				success: function(html){
		...
		$('#ajaddTourByDay').click(function(){
			...
			$.ajax({
				type: "POST",
				url: path_ajax_script+"/index.php?mod=event_tour&act=ajloadAddTourByDay",
		...
		$('.clkEdit').live('click',function(){
			...
			$.ajax({
				type: "POST",
				url: path_ajax_script+"/index.php?mod=event_tour&act=ajloadEditTourByDay",
				data: adata,
				dataType: "html",
				success: function(html){
		...
		$('#clickToSubmitTourByDay').live('click',function(){
			...
			$('#form-post').ajaxSubmit({
				'type' : 'POST',
				'url': path_ajax_script+"/index.php?mod=event_tour&act=ajSubmitTourByDay",
				data: {
					'tour_id': $_this.attr('tour_id'),
		...
		$('.clkDelete').live('click',function(){
			if(confirm(confirm_delete)){
				...
				$.ajax({
					type: "POST",
					url: path_ajax_script+"/index.php?mod=event_tour&act=ajRemoveTourByDays",
					data: adata,
					dataType: "html",
					success: function(html){
						loadListTourByDays();
		...
		$('.ajAddNewPriceFrom').live('click',function(){
			var $_this = $(this);
			var event_tour_id = $_this.attr('event_tour_id');
			var adata = {
				'event_tour_id' : event_tour_id,
			};
			$.ajax({
				type:'POST',	
				url:path_ajax_script+'/index.php?mod=event_tour&act=ajAddNewPriceFrom',
				data: adata,
				dataType:'html',	
				success:function(html){
		...
		$('.ajEditPriceFrom').live('click',function(){
			var $_this = $(this);
			var event_tour_id = $_this.attr('event_tour_id');
			var event_tour_price_id = $_this.attr('event_tour_price_id');
			var adata = {
				'event_tour_id' : event_tour_id,
				'event_tour_price_id' : event_tour_price_id,
			};
			$.ajax({
				type:'POST',	
				url:path_ajax_script+'/index.php?mod=event_tour&act=ajEditPriceFrom',
				data: adata,
				dataType:'html',	
				success:function(html){
					$('.price').isopriceformat({centsLimit: ''});
		...
		$('.clickDeletePriceFrom').live('click',function(){
			if(confirm(confirm_delete)){
				...
				var event_tour_price_id = $_this.attr('event_tour_price_id');
				var adata = {
					'event_tour_price_id' : $_this.attr('event_tour_price_id'),
					'event_tour_id' : $_this.attr('event_tour_id')
				};
				$.ajax({
					type: "POST",
					url: path_ajax_script+"/index.php?mod=event_tour&act=ajRemovePriceFrom",
					data: adata,
					dataType: "html",
					success: function(html){
						loadPriceFrom(event_tour_id);
		...
		$('.submitPriceFrom').live('click',function(){
			...
			$.ajax({
				type: "POST",
				url: path_ajax_script+"/?mod=event_tour&act=ajSubmitPriceFrom",
				data: adata,
				dataType: "html",
				cache: false,
				success: function(html){
...
function search_tour(){
	aj_search = setTimeout(function(){
		$.ajax({
			type:'POST',	
			url:path_ajax_script+'/index.php?mod=event_tour&act=ajGetSearch',	
...
function loadPriceFrom(tour_id) {
	var adata = {
		'event_tour_id' : tour_id,
	};
	$.ajax({
		type:'POST',	
		url:path_ajax_script+'/index.php?mod=event_tour&act=ajLoadPriceFrom',
		data: adata,
		dataType:'html',	
		success:function(html){
...
function loadTourExtension(tour_id){
	$.ajax({
		type:'POST',	
		url:path_ajax_script+'/index.php?mod=event_tour&act=ajLoadTourExtension',	
...
function loadDestination(tour_id){
	$.ajax({
		type: "POST",
		url:path_ajax_script+'/index.php?mod=event_tour&act=ajGetListSelectedDestination',	
...
function loadItinerary(tour_id){
	$.ajax({
		type: "POST",
		url:path_ajax_script+'/index.php?mod=event_tour&act=ajGetListItinerary',	
		data: {'tour_id' : tour_id},
		dataType: "html",
		success: function(html){
...
function func_updateItinerary(tour_id){
	...
	$.ajax({
		type: "POST",
		url:path_ajax_script+'/index.php?mod=event_tour&act=ajUpdateTourItinerary',	
		data: adata,
		dataType: "html",
		success: function(html){
			var htm = html.split('$$');
...
function getListCityByCountry(country_id,tour_id){
	...
	$.ajax({
		type: "POST",
		url: path_ajax_script+"/index.php?mod=event_tour&act=ajMakeListCityByCountry",
		data: adata,
		dataType: "html",
		success: function(html){
			$('#rightPop').html(html);
...
function loadTourPrice(){
	...
	$.ajax({
		type: 'POST',
		url:path_ajax_script+'/index.php?mod=event_tour&act=ajLoadTourPrice',
		data: adata,
		dataType:'html',
		success: function(html){
			$('#ajax-indicator').hide();
...
function generateItinerary(){
	...
	$.ajax({
		type: "POST",
		url: path_ajax_script+"/index.php?mod=event_tour&act=ajDynamicCalulationItinerary",
		data: adata,
		dataType: "html",
		success: function(html){}
	});	
...
function loadListCustomField(){
	...
	$.ajax({
		type: "POST",
		url: path_ajax_script+"/index.php?mod=event_tour&act=ajLoadListCustomField",
		data: adata,
		dataType: "html",
		success: function(html){
...
function makeSelectBoxTypeCustomField(){
	...
	$.ajax({
		type: "POST",
		url: path_ajax_script+"/index.php?mod=event_tour&act=ajMakeSelectBoxTypeCustomField",
		data: adata,
		dataType: "html",
		success: function(html){
			$('#type').html(html);
...
function loadListTourByDays($keyword,$departure_date,$page,$number_per_page){
	...
	$.ajax({
		type: "POST",
		url: path_ajax_script+"/index.php?mod=event_tour&act=ajLoadListToursByDays",
		data: adata,
		dataType: "html",
		success: function(html){
			var htm = html.split('$$');
