<div class="breadcrumb">
    ...
    <a>&raquo;</a>
    <a href="{$PCMS_URL}/index.php?mod={$mod}&act=edit&tour_id={$stringCruise}#isotab7">{$core->get_Lang('Tour')}</a>
    <!-- // -->
...
<div class="container-fluid">
    <div class="page-title">
        ...
        <i style="color:#F63">{$clsCruise->getTitle($tour_id)}</i>;
                        ...
                        <div class="row-span">
                            ...
                            <div class="fieldarea">
                                <select name="iso-type" class="glSlBox required" style="width:40%">
                                    <option {if $oneItem.type eq 'Tour'}selected="selected"{/if} value="Tour">Tour</option>
