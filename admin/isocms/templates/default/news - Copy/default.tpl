<div class="breadcrumb">
    ...
    <a>&raquo;</a>
    <a href="{$PCMS_URL}/index.php?mod={$mod}" title="{$mod}">{$core->get_Lang('news')}</a>
    <!-- // -->
    <a href="javascript:window.history.back();" class="back fr">{$core->get_Lang('back')}</a>
</div>
<div class="container-fluid">
    <div class="page-title">
        <h2>{$core->get_Lang('news')} <a class="btn btn-success" href="{$PCMS_URL}/?mod={$mod}&act=edit" title="{$core->get_Lang('add')}"> <i class="icon-plus icon-white"></i></a></h2>
        ...
        <div class="filterbox filterbox-border" style="width:100%">
            <div class="wrap">
                <div class="searchbox">
                    ...
                    <select name="newscat_id" onchange="_reload()" class="slb mr5 fl" style="padding:5px;">
                ...
                <div class="fr group_buttons">
					...
					<a href="javascript:void(0)" class="btn btn-danger btn-delete-all" clsTable="News" style="color:#fff; display:none"> <i class="icon-remove icon-white"></i> <span>{$core->get_Lang('Delete Options')}</span> </a>
					{/if}
