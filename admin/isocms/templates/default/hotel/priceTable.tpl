...
<script type="text/javascript">
	...
	$('#addHotelPriceRow').live('click',function(){
		...
		$.ajax({
			type: 'POST',
			url: path_ajax_request+'/index.php?mod=hotel&act=ajLoadNewHotelPriceRow', 
			dataType:'html', 
	...
	$('#addHotelPriceCol').live('click',function(){
		...
		$.ajax({
			type: 'POST',
			url: path_ajax_request+'/index.php?mod=hotel&act=ajLoadNewHotelPriceCol', 
			dataType:'html', 
			data: {'hotel_id':hotel_id},
			success: function(html){
				vietiso_loading(0);
	...
	function loadHotelPrice(){
		...
		$.ajax({
			type: 'POST',
			url: path_ajax_request+'/index.php?mod=hotel&act=ajLoadHotelPrice', 
			data: {'hotel_id':hotel_id},
			dataType:'html',
			success: function(html){
				vietiso_loading(0);
	...
	$('#clickToAddHotelPriceCol').live('click',function(){
		...
		$.ajax({
			type: 'POST',
			url: path_ajax_request+'/index.php?mod=hotel&act=ajAddHotelPriceCol', 
			data: adata,
			dataType:'html',
			success: function(html){
				vietiso_loading(0);
	...
	$('#clickToAddHotelPriceRow').live('click',function(){
		...
		$.ajax({
			type: 'POST',
			url: path_ajax_request+'/index.php?mod=hotel&act=ajAddHotelPriceRow', 
			data: adata,
			dataType:'html',
			success: function(html){
				vietiso_loading(0);
	...
	$('.editHotelPriceCol').live('click',function(){
		...
		$.ajax({
			type: 'POST',
			url: path_ajax_request+'/index.php?mod=hotel&act=ajLoadEditHotelPriceCol', 
			dataType:'html', 
	...
	$('.editHotelPriceRow').live('click',function(){
		...
		$.ajax({
			type: 'POST',
			url: path_ajax_request+'/index.php?mod=hotel&act=ajLoadEditHotelPriceRow', 
			dataType:'html', 
			data: {'id':_this.attr('data')},
			success: function(html){
				vietiso_loading(0);
	...
	$('#clickToEditHotelPriceRow').live('click',function(){
		...
		$.ajax({
			type: 'POST',
			url: path_ajax_request+'/index.php?mod=hotel&act=ajUpdateHotelPriceRow', 
			data: adata,
			dataType:'html',
			success: function(html){
				vietiso_loading(0);
	...
	$('#clickToEditHotelPriceCol').live('click',function(){
		...
		$.ajax({
			type: 'POST',
			url: path_ajax_request+'/index.php?mod=hotel&act=ajUpdateHotelPriceCol', 
			data: adata,
			dataType:'html',
			success: function(html){
				vietiso_loading(0);
	...
	$('.deleteHotelPriceRow').live('click',function(){
		if(confirm(confirm_delete)){
			...
			$.ajax({
				type: 'POST',
				url: path_ajax_request+'/index.php?mod=hotel&act=ajDeleteHotelPriceRow', 
				data: {'id':_this.attr('data')},
				dataType:'html',
				success: function(html){
					vietiso_loading(0);
	...
	$('.deleteHotelPriceCol').live('click',function(){
		if(confirm(confirm_delete)){
			...
			$.ajax({
				type: 'POST',
				url: path_ajax_request+'/index.php?mod=hotel&act=ajDeleteHotelPriceCol', 
				data: {'id':_this.attr('data')},
				dataType:'html',
				success: function(html){
					vietiso_loading(0);
	...
	$('.editHotelPriceVal').live('click',function(){
		...
		$.ajax({
			type: 'POST',
			url: path_ajax_request+'/index.php?mod=hotel&act=ajLoadEditHotelPriceVal', 
			dataType:'html', 
			data: {
	...
	$('#clickToEditHotelPriceVal').live('click',function(){
		...
		$.ajax({
			type: 'POST',
			url: path_ajax_request+'/index.php?mod=hotel&act=ajUpdateHotelPriceVal', 
			data: adata,
			dataType:'html',
			success: function(html){
				vietiso_loading(0);
	...
	$('.moveHotelPriceRow').live('click',function(){
		...
		$.ajax({
			type: 'POST',
			url: path_ajax_request+'/index.php?mod=hotel&act=ajMoveHotelPriceRow', 
			data: adata,
			dataType:'html',
			success: function(html){
				vietiso_loading(0);
	...
	$('.moveHotelPriceCol').live('click',function(){
		...
		$.ajax({
			type: 'POST',
			url: path_ajax_request+'/index.php?mod=hotel&act=ajMoveHotelPriceCol', 
			data: adata,
			dataType:'html',
			success: function(html){
				vietiso_loading(0);
