    ...
    <div class="container-fluid container-fluid-2 d-flex">
        ...
        <div class="content_setting_box">
            <div class="page_detail-title d-flex">
                <div class="title">
                    <h2>{$core->get_Lang('Cruise by Country')}</h2>
                    <p>Chức năng quản lý danh sách các Cruise by Country trong hệ thống isoCMS</p>
                    <p>{$core->get_Lang('This function is intended to manage Cruise by Country in isoCMS system')}</p>
                </div>
                <div class="button_right">
                    <a class="btn btn-main btn-addnew btnCreateCruiseCategoryCountry" href="javascript:void(0);" title="{$core->get_Lang('add')} {$core->get_Lang('Cruise by Country')}">{$core->get_Lang('add')} {$core->get_Lang('Cruise by Country')}</a>
                </div>
            </div>
            <div class="ui-action">
                <div class="wrap">
