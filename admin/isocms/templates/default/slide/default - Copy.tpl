<div class="breadcrumb">
    ...
    <a>&raquo;</a>
    <a href="{$PCMS_URL}/index.php?mod={$mod}{if $type eq '_CHILD_SLIDE'}&type=_CHILD_SLIDE{/if}" title="{$mod}">{$core->get_Lang('slide')}</a>
    <!-- Back-->
		...
		<div class=" filterbox">
			<div class="wrap">
				...
				<div class="fr group_buttons">
					...
					<a href="javascript:void(0)" class="btn btn-danger btn-delete-all" clsTable="Slide" style="color:#fff; display:none"> <i class="icon-remove icon-white"></i> <span>{$core->get_Lang('Delete Options')}</span> </a>
				</div>
			</div>
		</div>
                ...
                <td data-title="{$core->get_Lang('func')}" class="block_responsive" align="center" style="vertical-align: middle; text-align:center; width: 40px; white-space: nowrap;">
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu" style="right:0px !important">
                            ...
                            <li><a title="{$core->get_Lang('edit')}" href="{$PCMS_URL}/?mod={$mod}&act=edit&slide_id={$core->encryptID($allItem[i].slide_id)}{if $clsTable}&clsTable={$clsTable}{/if}"><i class="icon-edit"></i> <span>{$core->get_Lang('edit')}</span></a></li>
