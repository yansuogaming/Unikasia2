		...
		<div class="content_setting_box">
			<div class="page_detail-title d-flex">
				...
				<div class="button_right">
					<a class="btn btn-main btn-addnew add_new_category_country" title="{$core->get_Lang('Add')}">{$core->get_Lang('Add new')}</a>
				</div>
			</div>
							...
							<td data-title="{$core->get_Lang('func')}" class="block_responsive" align="center" style="vertical-align: middle; text-align:center; width: 40px; white-space: nowrap;">
								<div class="btn-group">
									...
									<ul class="dropdown-menu" style="right:0px !important">
										...
										<li><a title="{$core->get_Lang('edit')}" href="{$PCMS_URL}/tour/categorycountry/insert/{$allItem[i].category_country_id}/overview"><i class="icon-edit"></i> <span>{$core->get_Lang('edit')}</span></a></li>
