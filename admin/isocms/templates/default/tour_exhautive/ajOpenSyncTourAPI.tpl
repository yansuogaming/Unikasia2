...
<div class="headPop">
	<h3>{$core->get_Lang('syncTourAPIfromTMS')}</h3>
	...
	<div class="form-group form-row">
		...
		<div class="col-xs-12 col-md-8">
			<div class="custom-search-input">
				<input class="form-control input-lg mb-2 iso_search_field" toClass="trTourTMS" name="keysearch" id="keysearch" maxlength="255" charset="UTF-8" lang="{$_LANG_ID}" placeholder="Nhập từ khóa để tìm kiếm" />
...
<div class="modal-footer">
	<a href="javascript:void(0)" class="btn btn-success syncTourTMS">{$core->get_Lang('Sync')}<i class="fa fa-reply-all ml-2" aria-hidden="true"></i></a>
</div>