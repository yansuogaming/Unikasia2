			...
			<div class="modal-body">
				...
				<div class="row mt-4">
					...
					<div class="col-xs-12 col-md-4">
						...
						<textarea class="form-control mt10" name="img_gallery_title" placeholder="Tên ảnh"></textarea>
						{/if}
						<button type="button" class="btn btn-primary ui-cropper-tool mt10" tour_id="{$tour_id}" data-method="getCroppedCanvas">
							<i class="icon-ok icon-white"></i> <span>{$core->get_Lang('Save')}</span>
						</button>
						<button type="reset" class="btn btn-warning mt20" data-dismiss="modal">
							<i class="icon-retweet icon-white"></i> <span>{$core->get_Lang('Close')}</span>
						</button>
						<div class="well mt20">
							<p class="bold mb10">Khuyến nghị</p>
							Ảnh cần có độ phân giải cao: tối thiểu 2048 x 1110 pixel, tối đa là: 4000 x 2170 (kích cỡ ảnh tối đa có thể tải lên cho mỗi ảnh là 5MB)
						</p>
					</div>
				</div>
			</div>
