...
<div class="container-fluid">
    <div class="page-title">
        <h2>{$core->get_Lang('Travel Style list')} <a href="javascript:void(0);" class="btn btn-success btnCreateToursCategory" title="{$core->get_Lang('add')}"><i class="icon-plus icon-white"></i></a></h2>
		...
		<div class="ilterbox">
			<div class="wrap">
				<div class="searchbox">
					...
					<select class="slb" onchange="_reload()" name="tour_group_id">
					{$clsTourGroup->makeSelectboxOption($tour_group_id)}
					</select>
					{/if}
					<input type="text" class="text input32" name="keyword" value="{$keyword}" placeholder="{$core->get_Lang('search')}" />
					<a class="btn btn-success" id="searchbtn" style="padding:5px">
						<i class="icon-search icon-white"></i>
					</a>
				</div>
				<div class="group_buttons fr">
					<a href="{$PCMS_URL}/index.php?mod=tour" class="btn btn-warning">
		...
		<table width="100%" border="0" cellpadding="3" cellspacing="0">
			<tr>
				...
				<td width="50%" align="right">
					...
					<a class="btn btn-danger btn-delete-all" clsTable="TourCategory" style="display:none">
        ...
        <form method="post" action="" enctype="multipart/form-data">
            ...
            <table class="form" cellpadding="3" cellspacing="3">
                ...
                <tr>
                    ...
                    <td class="fieldarea">
                        {assign var=site_tours_link value=site_tours_link_$_LANG_ID}
...
$(document).ready(function(){
	...
	$(document).on('click', '.btnClickToSubmitCategory', function(ev){
		...
		/*var $intro_banner = tinyMCE.get($editorbannerID).getContent();*/
