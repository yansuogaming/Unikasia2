            ...
            <form id="frmEditTour" method="post" action="" enctype="multipart/form-data" class="validate-form">
                    ...
                    <div class="fr full_width_767 col-right">
                            ...
                            <div class="row-span">
                                ...
                                <div class="fieldarea">
                                    <div id="slb_ContainerTourCategory">
                                        <select name="cat_id[]" id="cat_id" class="text_32 full-width border_aaa required chosen-select" multiple style="width:250px">
                        ...
                        <div class="row-span">
                            ...
                            <div class="fieldarea">
                                <div id="slb_ContainerTourTag">
                                    <select name="tag_id[]" id="tag_id" class="text_32 full-width border_aaa chosen-select" multiple style="width:250px">
                        ...
                        {if $clsConfiguration->getValue('SiteHasDeparturePoint_Tours')}
                            <div class="row-span">
                                ...
                                <div class="fieldarea">
                                    <div id="slb_ContainerDepartPoint">
                                        <select name="departure_point_id[]" id="departure_point_id" class="text_32 full-width border_aaa chosen-select" multiple style="width:250px">
                        ...
                        <div class="row-span">
                            ...
                            <div class="fieldarea">
                                <label style="width:114px"><input class="margin_0" type="radio" name="iso-duration_type" value="0" {if $oneItem.duration_type ne '1'}checked="checked"{/if}/> {$core->get_Lang('Number Days')}:</label>
                                <select class="text_32 border_aaa w60" name="number_day" id="select_number_days" {if $oneItem.duration_type eq '1'}disabled="disabled" {/if}>
                                    {$clsISO->makeSelectNumber2(32,$oneItem.number_day)}
                                </select>
                                <label>/ {$core->get_Lang('Number Nights')}:</label>
                                <select class="text_32 border_aaa w60" name="number_night" id="select_number_nights" {if $oneItem.duration_type eq '1'}disabled="disabled" {/if}>
                                    {$clsISO->makeSelectNumber(32,$oneItem.number_night)}
                                </select>
                                <br/>
                                <div class="cleafix" style="margin-top:10px"></div>
                                <label style="width:114px;display: inline-block;"><input class="margin_0" type="radio" name="iso-duration_type" {if $oneItem.duration_type eq '1'}checked="checked"{/if} value="1" /> {$core->get_Lang('Option')}:</label>
                                <input type="text" class="text_32 border_aaa" {if $oneItem.duration_type ne '1'}disabled="disabled" {/if} name="iso-duration_custom" value="{$clsClassTable->getOneField('duration_custom',$pvalTable)}" style="width:238px" /> {literal}
                        ...
                        <div class="row-span">
                            ...
                            <div class="fieldarea"><input class="text_32 border_aaa w120 fontLarge" name="iso-trip_code" value="{$clsClassTable->getTripCode($pvalTable)}" maxlength="255" type="text"></div>
                        </div>
                        {if $clsConfiguration->getValue('SiteHasProgramFile_Tours')}
                            <div class="row-span">
                ...
                {if $clsISO->getBrowser() eq 'computer'}
                    <div id="v-nav">
                        <ul>
                            ...
                            <li class="tabchildcol"><a href="javascript:void(0);">{$core->get_Lang('What&#39;s to Carry')}</strong></a> <span class="color_r">*</span></li>
                            <li class="tabchildcol"><a href="javascript:void(0);">{$core->get_Lang('Cancellation Policy')}</strong></a> <span class="color_r">*</span></li>
                            <li class="tabchildcol"><a href="javascript:void(0);">{$core->get_Lang('Refund Policy')}</strong></a> <span class="color_r">*</span></li>
                            <li class="tabchildcol"><a href="javascript:void(0);">{$core->get_Lang('Confirmation Policy')}</strong></a> <span class="color_r">*</span></li>
                ...
                {else}
                    <div id="v-nav">
                        ...
                        <div class="row-span">
                            <div class="fieldlabel"><strong>{$core->get_Lang('What&#39;s to Carry')}<span class="color_r">*</span></strong></div>
                            <div class="fieldarea">
                                {$clsForm->ShowInput('thing_to_carry')}
                            </div>
                        </div>
                        ...
                        <div class="row-span">
                            <div class="fieldlabel"><strong>{$core->get_Lang('Refund Policy')}<span class="color_r">*</span></strong></div>
                            <div class="fieldarea">
                                {$clsForm->ShowInput('refund_policy')}
                            </div>
                        </div>
                        <div class="row-span">
                            <div class="fieldlabel"><strong>{$core->get_Lang('Confirmation Policy')}<span class="color_r">*</span></strong></div>
                            <div class="fieldarea">
                                {$clsForm->ShowInput('confirmation_policy')}
                            </div>
                        </div>
                                    ...
                                    {*<div class="contingency_table" style="display: none;">
                                        ...
                                        <table class="full-width tbl-grid" cellspacing="0">
                                            <tr>
                                                ...
                                                {/if}
                                                <td class="gridheader" style="text-align:left"><strong>{$core->get_Lang('Itinerary name')}</strong></td>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="row-span">
                            ...
                            {/if}
                            {if $clsConfiguration->getValue('SiteModActive_country') and $core->checkAccess('country')} {if $clsConfiguration->getValue('SiteHasGroup_Tours') && $clsClassTable->getOneField('tour_group_id',$pvalTable) eq '2'}
                                <input type="hidden" id="Hid_Country" name="country_id" value="1" />
                            {else}
                        ...
                        <form method="post" action="">
                            <div class="row-bottom">
                                ...
                                <div class="row-buttons" style="width:120px;">
                                    <div class="clear"></div>
                                    <button type="submit" class="btn-update" id="SaveTourStep10" name="submit" value="Update" style="margin-top:0; width:120px; padding:0 30px; float:right">
                                        <i class="iso-update"></i> {$core->get_Lang('Save')}
                                    </button>
...
<script type="text/javascript" src="{$URL_THEMES}/tour_exhautive/jquery.tour.js?v={$upd_version}"></script>
{literal}
    <script type="text/javascript">
