...
<div class="container-fluid">
    <div class="page-title">
    	<h2>{if $pvalTable}{$core->get_Lang('Edit Travel Styles by Country')}{else}{$core->get_Lang('Add Travel Styles by Country')}{/if}<a class="btn btn-success" href="{$PCMS_URL}/?mod={$mod}&act=edit_categorycountry" title="{$core->get_Lang('add')}"> <i class="icon-plus icon-white"></i></a>
        </h2>
        	...
        	<div class="tabbox" style="display:block">
                <div class="wrap">
                	<div class="fl col_Left full_width_767">
						<div class="photobox mb10 image">
							...
							{if $oneTable.image}
							<a pvalTable="{$pvalTable}" clsTable="Guide" href="javascript:void()" title="{$core->get_Lang('delete')}" class="photobox_edit deleteItemImage" g="imgItem">X</a>
							{/if}
							{else}
				...
				<div class="wrap mt20">
					...
					<div id="v-nav">
						...
						<div class="tab-content" style="display: none;">
							...
							<div class="photobox photoBanner span100">
								{if $_isoman_use eq '1'}
								<img src="{$clsClassTable->getBannerImage($pvalTable,1920,480)}" alt="{$core->get_Lang('images')}" id="isoman_show_image_banner" class="span100"/>
								...
								{/if}
								{else}
								<img src="{$clsClassTable->getBannerImage($pvalTable,1920,480)}" alt="{$core->get_Lang('noimages')}" id="imgTour_image_banner" class="span100"/>
					...
					<div id="v-nav">
						...
						<div class="row-span">
                            <div class="fieldlabel"><strong>{$core->get_Lang('Banner Size')} (1920x480)<font class="color_r">*</font></strong></div>
                            <div class="fieldarea">
								<div class="photobox photoBanner span100">
									{if $_isoman_use eq '1'}
									<img src="{$clsClassTable->getBannerImage($pvalTable,1920,480)}" alt="{$core->get_Lang('images')}" id="isoman_show_image_banner" class="span100"/>
