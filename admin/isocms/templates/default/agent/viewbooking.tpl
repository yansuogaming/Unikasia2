...
<div class="container-fluid">
            ...
            <div class="sidebar-wrapper">
                ...
                <div class="sidebar-row">
                    ...
                    <div class="profile-info">
                        ...
                        <p>{$clsAgent->getAddress($agent_id)}</p>
                        <p>
                        </p>
                    </div>
                </div>
                ...
                <div class="sidebar-row">
                    ...
                    <div class="profile-info">
                        <i class="icon-tag"></i>
                        <p class="strong">{$BookingStore.address_pick_up}</p>
                    </div>
                </div>
                <hr class="profile-info-delim">
            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 5px 10px; background-color: #ffffff; text-align: center; font-size: 12px; font-family: Arial;">                                                <table style="padding: 3px; white-space: nowrap; font-size: 12px; font-family: Arial;">
                                                    <tbody>
                                                        <tr>
															...
															{assign var=national_visitor_adult value=national_visitor$adult_type_id}
															{assign var=national_visitor_child value=national_visitor$child_type_id}
															{assign var=national_visitor_infant value=national_visitor$infant_type_id}
			
                                                            <td class="ty-right">
																 {$BookingStore.$national_visitor_adult}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td class="ty-right">
																{$BookingStore.$national_visitor_child}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td class="ty-right">
																{$BookingStore.$national_visitor_infant}
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            ...
                                            <td style="padding: 5px 10px; background-color: #ffffff; text-align: right; font-size: 12px; font-family: Arial;">
                                                <table style="padding: 3px; white-space: nowrap; font-size: 12px; font-family: Arial;">
                                                    <tbody>
														{assign var=people_price_adult value=people_price$adult_type_id}
														{assign var=people_price_child value=people_price$child_type_id}
														{assign var=people_price_infant value=people_price$infant_type_id}
                                                        <tr>
                                                            <td class="ty-right">
                                                                {$Currency}<span>
																{$BookingStore.$people_price_adult}</span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="ty-right">
																{if $BookingStore.$people_price_child ne ''}
                                                                {$Currency}<span>
																{$BookingStore.$people_price_child}
																</span>
																{else}
																-
																{/if}
                                                        ...
                                                        <tr>
                                                            <td class="ty-right">
																{if $BookingStore.$people_price_infant ne ''}
                                                                {$Currency}<span>
																{$BookingStore.$people_price_infant}
																</span>
																{else}
																-
																{/if}
    ...
    {$Currency}<span id="totalgrand1">{$BookingStore.price_total_amount}</span>
</b>&nbsp;</td>
                                        </tr>
                                    </tbody>
                                </table>
                                        ...
                                        <table class="pull-right">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td data-ct-totals="subtotal">{$Currency}<span id="totalgrand2">{$BookingStore.price_total_amount}</span></strong></td>
                                                </tr>
                                               {*<tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="price" data-ct-totals="total">
                                                        {$Currency}<span id="totalgrand4">{$BookingStore.price_remaining}</span>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
