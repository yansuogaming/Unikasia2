...
$listTourInBound = $clsTour->getAll("is_trash= 0 and is_online=1 and tour_group_id=2 order by order_no asc limit 0,8",$clsTour->pkey.",title,slug,duration_type,duration_custom,number_day,number_night,list_departure_point_id,image");
$smarty->assign('listTourInBound',$listTourInBound);
unset($listTourInBound);
