            ...
            <ol class="breadcrumb hidden-xs mt0 bg_fff" itemscope itemtype="https://schema.org/BreadcrumbList">
               ...
               <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
              	...
              	{if $oneItem.country_id}
					...
					<li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
					   <a itemprop="item" href="{$clsCountryEx->getLink($oneItem.country_id,'Hotel')}" title="{$title_country}">
						   <span itemprop="name" class="reb">{$title_country}</span></a>
            ...
            <div class="container">
				<section class="section_box_image_top">
					<div class="row">
						<div class="col-lg-8">
							<div class="big_image">
                                <img class="img100" alt="{$title_hotel}" src="{$clsHotel->getImage($hotel_id,850,391,$oneItem)}"/>
                                <p class="view_all" data-fancybox="gallery" href="{$oneItem.image}">{$core->get_Lang('See all')}</p>
							</div>
						</div>
						<div class="col-lg-4">
							<div class="list_image_small">
                                {section name=i loop=$listImage}
								<div class="small_image" data-fancybox="gallery" href="{$listImage[i].image}" {if $smarty.section.i.index gt 3}hidden{/if}>
                                    <img class="img100" alt="{$clsHotelImage->getTitle($listImage[i].hotel_image_id,$listImage[i])}" src="{$clsHotelImage->getImage($listImage[i].hotel_image_id,202,189,$listImage[i])}"/>
								</div>
                                {/section}
							</div>
						</div>
							...
							<div class="box_sec_title">
								<h1 class="sec_title">
                                    ...
                                    {*{if $clsHotel->getImageStar($oneItem.star_id) != ''}
                                        <img height="19" src="{$clsHotel->getImageStar($oneItem.star_id)}" alt="{$title_hotel}" style="width:auto"/>
                                    {/if}*}
								</h1>
								<div class="address">
									<i class="fa fa-map-marker"></i>&nbsp;&nbsp;{$clsHotel->getAddress($hotel_id,$oneItem)} -
                                    <a role="link" title="map" data-bs-toggle="modal" data-bs-target="#mapModal{$hotel__id}">{$core->get_Lang('Show map')}</a>
                                    <div class="modal fade mapModal" id="mapModal{$hotel__id}" tabindex="-1" aria-labelledby="mapModalLabel" aria-hidden="true">
               ...
               <section class="sec_info_hotel">
                   <h2 class="sec_info_title">{$title_hotel} {$core->get_Lang('Informations')}</h2>
                   <div class="important_note_box">
                       {if $_CheckInRoom || $_CheckOutRoom}
                       <div class="important_note_item">
                           <h3 class="note_title check_in_out">{$core->get_Lang('Check-in/check-out time')}</h3>
                           <div class="box_right">
                               <p class="box_right_content">{$_CheckInRoom} - {$_CheckOutRoom}</p>
                           </div>
                       </div>
                       {/if}
                       ...
                       <div class="important_note_item">
                           <h3 class="note_title booking_policy">{$core->get_Lang('Booking policy')}</h3>
                           <div class="box_right">
                       ...
                       {if $_ChildPolicy ne ''}
                       <div class="important_note_item">
                           <h3 class="note_title bed">{$core->get_Lang('Children policy and bed')}</h3>
                           <div class="box_right">
                       ...
                       <div class="important_note_item">
                           <h3 class="note_title cancel_prepay">{$core->get_Lang('Cancellation/prepayment')}</h3>
                           <div class="box_right">
                       ...
                       {if $_OtherPolicy ne ''}
                       <div class="important_note_item">
                           <h3 class="note_title other_regulation">{$core->get_Lang('Other regulations')}</h3>
                           <div class="box_right">
                           ...
                           {section name=i loop=$listCustomField}
                               {if $listCustomField[i].fieldvalue ne ''}
                                   <div class="important_note_item">
                                       ...
                                       <div class="box_right">
                                           <p class="box_right_content">{$listCustomField[i].fieldvalue|html_entity_decode}</p>
                                       </div>
                                   </div>
                               {/if}
                           {/section}
                ...
                <section class="customer_reviews">
                    <h2 class="customer_review_title">{$core->get_Lang('Customer reviews')}</h2>
                            ...
                            <div class="row align-items-center">
                                    ...
                                    <div class="box_score">
                                        ...
                                        <div class="score_text">
                                            ...
                                            <p class="number_review">
                                                {$ratingCount} {$core->get_Lang('Reviews')}
                                                <a class="view_all_review btn_write_review btn_write_review_login" href="javascript:void(0);" title="{$core->get_Lang('Reviews')}">{$core->get_Lang('Reviews')}</a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                   	<div class="box_rate_score">
										...
										<div class="d-flex flex-wrap justify-content-between align-items-center">
											<div class="progress">
												<div class="progress-bar" role="progressbar" aria-valuenow="{$staff}" aria-valuemin="0" aria-valuemax="100" style="width: {$lstReviewHotel.staff}%"></div>
											</div>
											<span>{$staff}</span>
										</div>
									</div>
                                   	<div class="box_rate_score">
										...
										<div class="d-flex flex-wrap justify-content-between align-items-center">
											<div class="progress">
												<div class="progress-bar" role="progressbar" aria-valuenow="{$place}" aria-valuemin="0" aria-valuemax="100" style="width: {$lstReviewHotel.place}%"></div>
											</div>
											<span>{$place}</span>
										</div>
									</div>
                                ...
                                <div class="col-lg-3">
                                   	<div class="box_rate_score">
										...
										<div class="d-flex flex-wrap justify-content-between align-items-center">
											<div class="progress">
												<div class="progress-bar" role="progressbar" aria-valuenow="{$amenities}" aria-valuemin="0" aria-valuemax="100" style="width: {$lstReviewHotel.amenities}%"></div>
											</div>
											<span>{$amenities}</span>
										</div>
									</div>
                                   	<div class="box_rate_score">
										...
										<div class="d-flex flex-wrap justify-content-between align-items-center">
											<div class="progress">
												<div class="progress-bar" role="progressbar" aria-valuenow="{$food_drink}" aria-valuemin="0" aria-valuemax="100" style="width: {$lstReviewHotel.food_drink}%"></div>
											</div>
                                ...
                                <div class="col-lg-3">
                                   	<div class="box_rate_score">
										...
										<div class="d-flex flex-wrap justify-content-between align-items-center">
											<div class="progress">
												<div class="progress-bar" role="progressbar" aria-valuenow="{$clean}" aria-valuemin="0" aria-valuemax="100" style="width: {$lstReviewHotel.clean}%"></div>
											</div>
											<span>{$clean}</span>
										</div>
									</div>
                                   	<div class="box_rate_score">
										...
										<div class="d-flex flex-wrap justify-content-between align-items-center">
											<div class="progress">
												<div class="progress-bar" role="progressbar" aria-valuenow="{$worthy}" aria-valuemin="0" aria-valuemax="100" style="width: {$lstReviewHotel.worthy}%"></div>
											</div>
											<span>{$worthy}</span>
										</div>
									</div>
                           ...
                           {section name=i loop=$lstReview}
								...
								<div class="customer_reviews_item review_item">
									<div class="customer_intro">
										<div class="customer_avatar avatar">{$lstReview[i].fullname|truncate:1:"":true}</div>
