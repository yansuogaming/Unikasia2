	...
	<div class="row">
		<div class="col-lg-8">
			<div class="list_cabin">
				...
				{section name=i loop=$arraycheckrateCabin.number_cabin}
				<div class="cabin_item">
					...
					<div class="cabin_body">
						...
						<form action="" method="post">
							...
							{$clsCruiseCabin->getCheckRatePriceCabinCruise($cruise_cabin_id,$arraycheckrateCabin,$promotion_date,$cruise_id,$smarty.section.i.iteration)}
						</form>
											...
											<div class="col-md-6">
												...
												<div class="m-item" style="margin-top:30px">
													...
													<div class="m-content">
														...
														<p><strong>{$core->get_Lang('Extra Bed')}:</strong>  {if $clsCruiseCabin->getOneField('extra_bed',$cruise_cabin_id)==0}{$core->get_Lang('No')}{else}{$core->get_Lang('Yes')}{/if}</p>
													</div>
												</div>
											</div>
											<div class="col-md-6">
