    ...
    var nextGenWPTheme = {
        ...
        slickInit: function() {
            ...
            $('.hot-offer-block .theme-slider .slides-list').on('afterChange', function(slick, currentSlide) {
                var _title = $('.hot-offer-block .theme-slider .slide').eq(currentSlide.currentSlide + 1).data('title');
                var _intro = $('.hot-offer-block .theme-slider .slide').eq(currentSlide.currentSlide + 1).data('description');
                var _link = $('.hot-offer-block .theme-slider .slide').eq(currentSlide.currentSlide + 1).data('link');
                $('.hot-offer-block .hot-offer-description h3').text(_title);
                $('.hot-offer-block .hot-offer-description p').text(_intro);
                $('.hot-offer-block .hot-offer-description .link').attr('href', _link).attr('title', _title);
