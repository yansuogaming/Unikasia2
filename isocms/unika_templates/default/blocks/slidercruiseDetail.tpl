<div class="sliderWrapper block1140 removeblock1140" style="display:none">
	{if $lstImage ne ''}
    <div id="sliderTourDetail" class="owl-carousel">
    	<div class="sliderItem">
			<img src="{$clsCruise->getImage($cruise_id,944,629)}" width="100%" alt="" />
        </div>
    	{section name=i loop=$lstImage} 
        <div class="sliderItem" style="cursor:pointer">
			<img src="{$clsCruiseImage->getImage($lstImage[i].cruise_image_id,944,629)}" width="100%" alt="" />
        </div>
        {/section}
    </div>
    {else}
