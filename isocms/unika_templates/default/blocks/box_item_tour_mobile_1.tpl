...
<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 box">
	<div class="item__tour {$deviceType}">
		<a href="{$getLink}" title="{$getTitle}">
		<div class="image relative">
			<img src="{$clsConfiguration->getImage('default_image_pixel',3,2)}" data-src="{$clsTour->getImage($tour_id,385,256)}" alt="{$getTitle}" class="lazy img100">
		...
		<div class="body">
			...
			<div class="body_info_tour">
				<div class="body_review mt10">
					<p class="review_rate"><span class="rate_avg">{$getRateAvg}</span> 
						<label class="rate-2019 block">{$getStarNew}</label></p>
