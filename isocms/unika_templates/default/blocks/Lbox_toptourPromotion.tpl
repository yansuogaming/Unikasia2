...
<section class="section_box attractive_tour">
    ...
    <div class="attractive_tour--content">
        ...
        {if $totalRecord gt 8}
            <div class="view_more">
                <a href="javascript:void(0);" page="1" rel="nofollow"  class="show-loader btn_view_more" _type="TopTourPromotion" id="show-more" title="{$core->get_Lang('View more')}">{$core->get_Lang('View more')}</a>
            </div>
        {/if}
    </div>
    <script>
