	{*<a href="javascript:void(0);" title="Zoom" class="google-map__zoom hidden" combo_id="{$combo_id}"><i class="fa fa-expand"></i></a>*}
	<div id="map_canvas" style="width: 435px; height:296px;"></div>
<script>
	var map_la = '{$map_la}';
	var map_lo = '{$map_lo}';
	...
	$().ready(function(){
		...
		$('.google-map__zoom').click(function(){
			...
			if(!$_this.hasClass('clicked')){
				...
				var combo_id = $_this.attr('combo_id');
				$.post('/index.php?mod=tour&act=map',{'combo_id':combo_id}, function(html){
					$_this.removeClass('clicked');
					makepopup('90%','90%',html,'OpenMap_'+combo_id);
					initialize('map_canvas_'+combo_id,9);
				});
			}
			return false;
		});
