				...
				<section class="signformM_section">
					<form id="signformM_form" method="post" action="" enctype="multipart/form-data" class="AppForm signformM_form">
						...
						<div class="remember-forgot">
							...
							<a id="ForgotPassLink" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#exampleModal" class="fr f_h_main">{$core->get_Lang('Forgot password')}?</a>
...
var reset_success = "{$core->get_Lang('Submit request successful &#33; Please check your email and reset your new password')}.";
</script>
{literal}
<script type="text/javascript">
