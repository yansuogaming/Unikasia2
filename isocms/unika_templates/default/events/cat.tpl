<div class="page_container ListEvents EventsDefault">
	<div class="banner">
		<img class="full-width height-auto" src="{$oneEventCat.image}" alt="">
		<div class="titlePage">
			<h1 class="TitlePage">{$oneEventCat.title}</h1>
			<div class="intro">{$oneEventCat.intro|html_entity_decode}</div>
		</div>
							...
							<div class="row">
								...
								<div class="col-md-5">
									<div class="body">
										...
										<p class="date text_bold text-uppercase mb0 d-flex"><i class="fa fa-calendar-o w_25px mt5" aria-hidden="true"></i>
