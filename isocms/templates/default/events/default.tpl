<div class="page_container ListEvents EventsDefault">
	<div class="banner">
		<img class="full-width height-auto" src="{$SiteBannerEvent}" alt="{$core->get_Lang('Events')}">
		<div class="titlePage">
			<h1 class="TitlePage">{$core->get_Lang('Events')}</h1>
				...
				{section name=i loop=$listEvent}
					<div class="item_event">
						<div class="container">
							...
							<div class="col-md-6">
								<a class="photo" href="{$clsISO->getLinkEvent($listEvent[i].slug,$listEvent[i].event_id)}" title="{$listEvent[i].title}">
							...
							<div class="col-md-5">
								<div class="body">
									...
									<div class="header_article mb10">
										<a class="title_cat size14" title="{$listEvent[i].title_cat}" href="{$clsISO->getLinkEventCat($listEvent[i].slug_cat,$listEvent[i].eventcat_id)}">{$listEvent[i].title_cat}</a>
									</div>
									<p class="location text_bold d-flex"><i class="fa fa-map-marker w_25px mt5" aria-hidden="true"></i>
