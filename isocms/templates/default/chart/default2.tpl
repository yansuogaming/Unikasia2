...
<script type="text/javascript" src="{$URL_JS}/chart/highcharts-more.js?v={$upd_version}"></script>
...
<script type="text/javascript" src="{$URL_JS}/chart/accessibility.js?v={$upd_version}"></script>
...
Highcharts.chart('container2', {
    ...
    xAxis: {
        categories: [{/literal}{$clsCity->getCategoriesChart()}{literal}],
