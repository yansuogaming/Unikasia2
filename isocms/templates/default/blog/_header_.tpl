                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-2 col-md-2 d-flex align-items-center">
                            <a href="{PCMS_URL}" title="Home">
                            <img class="img_logoheader" src="{URL_IMAGES}/home/logo-hnvoyages.png" alt="Logo">
                        </a>
                        </div>
                        <div class="col-lg-8 col-md-12 col-sm1-12 d-flex align-items-center justify-content-center list_dropdownmenu">
                            <div class="dropdown">
