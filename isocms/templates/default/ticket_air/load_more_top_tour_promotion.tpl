        ...
        <div class="item__tour">
            <div class="image relative">
                <a href="{$getLink}" title="{$getTitle}">
                    <img src="{$clsTour->getImage($listTopTourPromotion[i].taget_id,385,256)}" alt="{$getTitle}" class="lazy img100">
                </a>
            ...
            <div class="body">
                ...
                <div class="additional_infor">
                    <span class="duration">{$clsTour->getTripDuration2019($listTopTourPromotion[i].taget_id)}</span>
                ...
                <div class="price">
                    ...
                    <a href="{$getLink}" title="Chi tiết" class="link_tour color_1c1c1c">
                        Chi tiết
                    </a>
                </div>
            </div>
