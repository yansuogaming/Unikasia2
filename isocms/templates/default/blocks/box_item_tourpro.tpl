		...
		<div class="itemTrip {$deviceType}">
			<a href="{$getLink}" title="{$getTitle}">
				<div class="image relative">
					<img src="{$clsConfiguration->getImage('default_image_pixel',296,196)}" data-src="{$clsTour->getImage($tour_id,296,196)}" alt="{$getTitle}" class="{if $mod eq 'home' || $act eq 'detaildeparture'}owl-lazy{else}lazy{/if} img100">
