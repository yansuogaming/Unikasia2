...
<section class="subscribe_Home section_box bg_main">
	<div class="container">
		<h2 class="title mb10 size32 text-uppercase text-center text_bold">{$core->get_Lang('Save money right from your journey')}</h2>
		<div class="intro mb30">
			{$core->get_Lang('Enter your email to receive the best deals')}
		</div>
		<div class="regiter_email">
			<form method="post" action="{$extLang}" class="subscribe__form">
				...
				<input class="btn_Subscribe btn_main" id="submitSubscribeHome" type="button" name="btnSubmit" value="{$core->get_Lang('Send now')}">
