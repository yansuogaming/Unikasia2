<div class="container">
	<form class="find__trip--form" method="post" action="{$extLang}/">
		<div class="input_key_word">
			<input type="text" class="form-control" name="key" value="" placeholder="{$core->get_Lang('Tìm tour')}....">
		</div>
		...
		<button type="submit" class="btn btn_find_trip" id="findtBtn">{$core->get_Lang('Tìm kiếm')}</button>
