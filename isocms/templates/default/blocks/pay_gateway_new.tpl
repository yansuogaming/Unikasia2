<div class="billingInfo bg_fff pd20_991 mb20">
	{if $mod eq 'tour'}
	<h3 class="size18"><span class="number">3</span>{$core->get_Lang('Billing Information')}</h3>
	{/if}
    <div class="booking_tab">
        <div class="payment-choice">
            ...
            {if $clsISO->getVar('PAYMENT_ONLINE_GLOBAL')}         
                ...
                {if $clsConfiguration->getValue('VNPay_Status_Mode')}
                <div id="divATM" >
                  <label style="cursor:pointer;" class="mb10"><input type="radio" class="chkPayment ATMDefault" name="payment_method" {if $payment_method eq $PAYMENT_VNPAY_GATEWAY}checked="checked"{/if} value="{$PAYMENT_VNPAY_GATEWAY}"><img src="{$URL_IMAGES}/icon/vnpay.png" alt=""></label><br>
                </div>
                {/if}
            {/if}
