									...
									<div class="box_infor_customer">
										...
										<div class="group-1 dp-flex">
											...
											<div class="form-group full_name">
												...
												<input id="fullname" name="fullname" placeholder="" type="text" class="form-booking_input" value="{$oneProfile.full_name}"/>
											</div>
										...
										<div class="group-2 dp-flex">
											<div class="form-group telephone">
												...
												<input id="telephone" name="telephone" placeholder="" type="text" class="form-booking_input" value="{$oneProfile.phone}">
											</div>
											<div class="form-group email">
												<label>{$core->get_Lang('Email')} <span style="color: red">*</span></label>
												<input id="email" name="email" placeholder="" type="email" class="form-booking_input" value="{$oneProfile.email}"/>
											</div>
										</div>
										...
										<div class="group-3 dp-flex">
											...
											{*<div class="form-group address">
												<input name="address" placeholder="{$core->get_Lang('Enter your detailed address')}" type="text" class="required form-booking_input">
											</div>*}
										</div>
										<div class="form-group mb0">
											<label style="vertical-align:top">{$core->get_Lang('Messager')}</label>
											<textarea rows="7" class="form-control" cols="50" name="note" placeholder="{$core->get_Lang('Enter your wish, request...')}"></textarea>
										</div>
									</div>
								</div>
							</div>
