                ...
                <div class="row align-items-center">
                    <div class="col-lg-3">
                        <div class="box_score">
                            ...
                            <div class="score_text">
                                ...
                                <p class="number_review">
                                    {$ratingCount} {$core->get_Lang('Reviews')}
                                    <a class="view_all_review btn_write_review btn_write_review_login"
                                        href="javascript:void(0);"
                                        title="{$core->get_Lang('Reviews')}">{$core->get_Lang('Review s')}</a>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="box_rate_score">
                            ...
                            <div class="d-flex flex-wrap justify-content-between align-items-center">
                                <div class="progress">
                                    <div class="progress-bar" role="progressbar" aria-valuenow="{$staff}" aria-valuemin="0"
                                        aria-valuemax="100" style="width: {$lstReviewHotel.staff}%"></div>
                                </div>
                                <span>{$staff}</span>
                            </div>
                        </div>
                        <div class="box_rate_score">
                            ...
                            <div class="d-flex flex-wrap justify-content-between align-items-center">
                                <div class="progress">
                                    <div class="progress-bar" role="progressbar" aria-valuenow="{$place}" aria-valuemin="0"
                                        aria-valuemax="100" style="width: {$lstReviewHotel.place}%"></div>
                                </div>
                                <span>{$place}</span>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3">
                        <div class="box_rate_score">
                            ...
                            <div class="d-flex flex-wrap justify-content-between align-items-center">
                                <div class="progress">
                                    <div class="progress-bar" role="progressbar" aria-valuenow="{$amenities}"
                                        aria-valuemin="0" aria-valuemax="100" style="width: {$lstReviewHotel.amenities}%">
                                    </div>
                                </div>
                                <span>{$amenities}</span>
                            </div>
                        ...
                        <div class="box_rate_score">
                            ...
                            <div class="d-flex flex-wrap justify-content-between align-items-center">
                                <div class="progress">
                                    <div class="progress-bar" role="progressbar" aria-valuenow="{$food_drink}"
                                        aria-valuemin="0" aria-valuemax="100" style="width: {$lstReviewHotel.food_drink}%">
                                    </div>
                                </div>
                                <span>{$food_drink}</span>
                            </div>
                    ...
                    <div class="col-lg-3">
                        <div class="box_rate_score">
                            ...
                            <div class="d-flex flex-wrap justify-content-between align-items-center">
                                <div class="progress">
                                    <div class="progress-bar" role="progressbar" aria-valuenow="{$clean}" aria-valuemin="0"
                                        aria-valuemax="100" style="width: {$lstReviewHotel.clean}%"></div>
                                </div>
                                <span>{$clean}</span>
                            </div>
                        </div>
                        <div class="box_rate_score">
                            ...
                            <div class="d-flex flex-wrap justify-content-between align-items-center">
                                <div class="progress">
                                    <div class="progress-bar" role="progressbar" aria-valuenow="{$worthy}" aria-valuemin="0"
                                        aria-valuemax="100" style="width: {$lstReviewHotel.worthy}%"></div>
                                </div>
                                <span>{$worthy}</span>
                            </div>
                        </div>
