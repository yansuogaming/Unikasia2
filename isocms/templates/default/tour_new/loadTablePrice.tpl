                ...
                <div class="box__price--header d-flex">
					...
					<div class="box_right">
                        ...
                        <div class="price">
                            ...
                            {/if}
                            <span class="size28 color_fb1111 text_bold">{$clsISO->getShortRate()}{$total_price_promotion_z} </span>
                        </div>
                    </div>
					{/if}
                </div>
					...
					{if $_LANG_ID eq 'vn'}
						<div class="box_right">
							...
							<ul class="list_style_none list_detail_price">
								...
								{if $number_child}
								<li class="flex-wrap">
									<div class="d-flex flex-wrap w-100 collapseHead collapsed" {if $arr_price_child|count gt 0}data-bs-toggle="collapse" data-bs-target="#collapseChild" aria-expanded="false" aria-controls="collapseChild"{/if}>
                                        ...
                                        {if $check_contact_child eq 0 && $total_price_child ne 0}
                                            ...
                                            <span class="price text_right">{$total_price_child|number_format:0:".":","} {$clsISO->getShortRate()}</span>
                                        {else}
                                            <span class="w_120 text_right">{if $arr_price_child|count gt 0}<i class="fa fa-angle-down" aria-hidden="true"></i>{/if}</span>
										...
										{section name=i loop=$arr_price_child}
											<div class="d-flex flex-wrap w-100">
												...
												{if $arr_price_child[i].price gt 0}
													<span class="w_120 text_right">x {$arr_price_child[i].price|number_format:0:".":","} {$clsISO->getShortRate()}</span> <span class="price text_right">{$arr_price_child[i].total_price|number_format:0:".":","} {$clsISO->getShortRate()}</span>
												{else}
								...
								{if $number_infants}
									<li class="flex-wrap">
										<div class="d-flex flex-wrap w-100 collapseHead collapsed" {if $arr_price_infant|count gt 0}data-bs-toggle="collapse" data-bs-target="#collapseInfant" aria-expanded="false" aria-controls="collapseInfant"{/if}>
                                            ...
                                            {if $check_contact_infant eq 0 && $total_price_infants ne 0}
                                                ...
                                                <span class="price text_right">{$total_price_infants|number_format:0:".":","} {$clsISO->getShortRate()}</span>
                                            {else}
                                               	<span class="w_120 text_right">{if $arr_price_infant|count gt 0}<i class="fa fa-angle-down" aria-hidden="true"></i>{/if}</span>
                                                <span class="price text_right">{$core->get_Lang('Contact')}</span>
                                            {/if}
											...
											{section name=i loop=$arr_price_infant}
												<div class="d-flex flex-wrap w-100">
													...
													{if $arr_price_infant[i].price gt 0}
														<span class="w_120 text_right">x {$arr_price_infant[i].price|number_format:0:".":","} {$clsISO->getShortRate()}</span> <span class="price text_right">{$arr_price_infant[i].total_price|number_format:0:".":","} {$clsISO->getShortRate()}</span>
													{else}
														<span class="w_120 text_right"></span>
														<span class="price text_right">{$core->get_Lang('Contact')}</span>
													{/if}
						...
						<div class="box_right">
							...
							<ul class="list_style_none list_detail_price">
								...
								{if $promotion}
									...
									{else}
										<li class="promotion color_1fb69a "> <span class="w_240 text_left">{$core->get_Lang('Promotion')}</span> <span class="w_120 text_right">-{$clsISO->getShortRate()}{$promotion|number_format:0:".":","}</span> <span class="price text_right">-{$clsISO->getShortRate()}{$price_promotion|number_format:0:".":","}</span></li>
									{/if}
								{/if}
							</ul>
							<ul class="list_style_none list_detail_price" id="box__price__addon"></ul>
							<ul class="list_style_none list_detail_price">
								<li class="total_price">
									...
									<span class="price text_right size20 color_fb1111 text_bold" >
										<span id="grand_total" grand_total="{$total_price_promotion}">{$clsISO->getShortRate()}{$total_price_promotion_z}</span>
									</span>
								</li>
							</ul>
						</div>
