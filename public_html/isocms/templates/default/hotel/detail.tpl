...
<script type="application/ld+json">
    {
        ...
        "description": "{/literal}{$intro_hotel|html_entity_decode|replace:'"
        ':'\
        "'|strip_tags}{literal}",
        "address": {
            "@type": "PostalAddress",
...
<section class="detail_hotel_body pageen stayBody computer">
    <div class="page_container page_detail_stay bg_fff">
        <nav class="breadcrumb-main  breadcrumb-cruise bg-default breadcrumb-more bg_fff">
            <div class="container">
                <ul class="breadcrumb hidden-xs mt0 bg_fff navbarHeads" itemscope itemtype="https://schema.org/BreadcrumbList">
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="big_image" data-fancybox="gallery-hotel" href="{$listImage[i].image}">
                                <img class="img_big" alt="{$clsHotelImage->getTitle($listImage[i].hotel_image_id,$listImage[i])}" src="{$clsHotelImage->getImage($listImage[i].hotel_image_id,841,420)}" />
                            </div>
                            {/section}
                        ...
                        <div class="col-lg-4">
                            <div class="list_image_small">
                                ...
                                <div class="small_image" data-fancybox="gallery-hotel" href="{$listImage[i].image}" {if $smarty.section.i.index gt 4}hidden{/if}>
                                    <img class="img_small" alt="{$clsHotelImage->getTitle($listImage[i].hotel_image_id,$listImage[i])}" src="{$clsHotelImage->getImage($listImage[i].hotel_image_id,202,202)}" />
                        ...
                        <section class="box_right_info_hotel sticky_fix">
                            <div class="box_info_right_top">
                                ...
                                <div class="price_from_text">
                                    ...
                                    <div class="val_price">
                                        <p class="txt_prival">US
                                        <h3 class="numb_prival">{if $clsHotel->getPriceAvg($hotel_id)}
                                ...
                                <div class="btn_contactus">
                                    ...
                                    <a href="{$PCMS_URL}contact-us.html" alt="contactus" title="contactus">
                                        <button class="btn btn_contactprice">{$core->get_Lang('Contact')} <i class="fa-regular fa-arrow-right" style="color: #ffffff;"></i>
                                        </button>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="important_note_box">
                                ...
                                <div class="important_note_item">
                                    <h3 class="note_title cancel_prepay">
                                        <i class="fa-solid fa-circle-info fa-xl" style="color: #004ea8; margin-right:8px"></i>
                                        {$core->get_Lang('Cancel reservation/ Prepay')}
                                    </h3>
                                    <div class="box_right">
                                ...
                                <div class="col-lg-7 measure-evaluation-txt">
                                    ...
                                    <div class="box_rate_score">
                                        ...
                                        <div class="d-flex flex-wrap justify-content-between align-items-center">
                                            <div class="progress">
                                                <div class="progress-bar" role="progressbar" aria-valuemin="0" aria-valuemax="100" style="width:{$reviewProgress[i].count_percent}%">
                                                </div>
                                            </div>
                                    ...
                                    <a class="view_all_review btn_write_review btn_write_review_login Write-reviews" href="javascript:void(0);" title="{$core->get_Lang('Reviews')}">{$core->get_Lang('Write reviews')}</a>
                                </div>
                            </div>
                        </div>
...
<style>
    .unika_header .navbar-nav {
        gap: 40px !important;
        /* Sử dụng !important để tăng độ ưu tiên */
    }
</style>
