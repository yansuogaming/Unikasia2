...
$minExpected = '';
$minExpected .= file_get_contents(URL_JS.'/compress/jquery-vietiso-2.2.4.min.js');
$minExpected .= file_get_contents(URL_JS.'/venobox.min.js');
$minExpected .= file_get_contents(URL_JS.'/makepop.js');
$minExpected .= file_get_contents(URL_JS.'/jquery.countdown.min.js');
$minExpected .= file_get_contents(URL_JS.'/jquery.lockfixed.js');
$minExpected .= file_get_contents(URL_JS.'/swiper.min.js');
$minExpected .= file_get_contents(URL_JS.'/jquery.ui.touch-punch.min.js');


if(1==2){
$minExpected .= file_get_contents(URL_JS.'/jquery-simple-mobilemenu.min.js');
