...
function websdkready() {
  ...
  var API_KEY = "rAaeKUEbRoGyYaCwSpdQjg";
   ...
   */
  var API_SECRET = "iNnoB8SM4jhotoMeoZMhM2dOFOeMZb7OtNP7";
  ...
  document.getElementById("clear_all").addEventListener("click", function (e) {
    ...
    window.location.href = "/zoom_web/CDN/index.html";
  });
    ...
    .addEventListener("click", function (e) {
      ...
      var signature = ZoomMtg.generateSignature({
        ...
        success: function (res) {
          ...
          var joinUrl = "/zoom_web/CDN/meeting.html?" + testTool.serialize(meetingConfig);
          console.log(joinUrl);
